  ...
  metrics: [
    {
      ...
      colorTheme: {
        ...
        cardHoverBg:
          "hover:bg-emerald-50/40 hover:border-emerald-300 hover:shadow-[0_12px_28px_rgba(5,150,105,0.12)]",
    ...
    },
    {
      ...
      colorTheme: {
        ...
        cardHoverBg:
          "hover:bg-sky-50/40 hover:border-sky-300 hover:shadow-[0_12px_28px_rgba(2,132,199,0.12)]",
    ...
    },
    {
      ...
      colorTheme: {
        ...
        cardHoverBg:
          "hover:bg-violet-50/40 hover:border-violet-300 hover:shadow-[0_12px_28px_rgba(124,58,237,0.12)]",
    ...
    },
    {
      ...
      colorTheme: {
        ...
        cardHoverBg:
          "hover:bg-rose-50/40 hover:border-rose-300 hover:shadow-[0_12px_28px_rgba(225,29,72,0.12)]",

...
import DeveloperProfile from './04.DeveloperProfile'
...
interface DeveloperAndOwnerProps {
  isMobile: boolean
}

export default function DeveloperAndOwner({ isMobile }: DeveloperAndOwnerProps) {
  return (
    <ThemeProvider>

...
export default function DesktopDeveloperProfile() {
  ...
  return (
    <div className="relative w-full overflow-hidden bg-gray-50 py-24 transition-colors duration-700 dark:bg-[#030712]">
      <Container className="relative z-10 max-w-7xl px-4 xl:px-0">
        ...
        <div className="flex gap-12 rounded-[8px] bg-white p-8 shadow-xl dark:bg-[#0a101d] dark:border dark:border-gray-800">
          
          <div className="flex w-1/3 flex-col gap-3 border-r border-gray-100 pr-8 dark:border-gray-800">
            <h3 className="mb-4 text-[0.8rem] font-bold uppercase tracking-widest text-gray-400">Select Profile</h3>
            {DeveloperProfileData.pills.map((pill, idx) => (
              ...
              >
                ...
                {activeTab === idx && <ChevronRight size={18} className="text-white/70 dark:text-gray-900/70" />}
              </button>
            ))}
          </div>
          ...
          <div className="flex w-2/3 flex-col py-2 pl-4">
            <div className="mb-8 flex items-center gap-3">
              ...
              <h3 className="text-xl font-black text-gray-900 dark:text-white">{DeveloperProfileData.expectationsTitle}</h3>
            </div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                {DeveloperProfileData.expectations.map((exp, idx) => (

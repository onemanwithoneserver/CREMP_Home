  ...
  return (
    <div className="relative w-full overflow-hidden bg-gray-50 px-4 py-16 transition-colors duration-700 dark:bg-[#030712]">
      ...
      <motion.div variants={staggerContainer} initial="hidden" whileInView="show" viewport={{ once: true, margin: "-50px" }} className="relative z-10 flex flex-col gap-6">
        ...
        <motion.div variants={fadeInUp} className="rounded-[8px] border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-[#0a101d]">
          ...
          <div className="flex flex-col gap-3">
            {whyInvestData.issues.map((issue, idx) => (
              <div key={idx} className="flex items-center gap-3 rounded-[8px] border border-gray-100 bg-gray-50/50 p-3 dark:border-gray-800/50 dark:bg-gray-800/20 transition-all duration-300 hover:shadow-lg hover:border-[#D4AF37]/50">
        ...
        <motion.div variants={fadeInUp} className="rounded-[8px] border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-[#0a101d]">
          ...
          <div className="grid grid-cols-2 gap-3">
            {whyInvestData.flowItems.map((item, idx) => (
              <div key={idx} className="flex flex-col items-center justify-center gap-2 rounded-[8px] border border-gray-100 bg-gray-50 p-4 dark:border-gray-800 dark:bg-[#0a1128] transition-all duration-300 hover:shadow-lg hover:border-[#D4AF37]/50">
                <item.icon size={20} className="text-[#D4AF37] dark:text-[#D4AF37]" />
        ...
        <motion.div variants={fadeInUp} className="rounded-[8px] bg-gradient-to-br from-[#D4AF37] to-[#b38728] p-8 shadow-xl dark:from-[#0a101d] dark:to-[#0a1128] dark:border dark:border-gray-800 text-center relative overflow-hidden">

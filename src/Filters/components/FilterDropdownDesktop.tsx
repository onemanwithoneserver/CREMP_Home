          ...
          <div className="space-y-2.5">
            ...
            >
              ...
              >
                ...
                <motion.div
                  animate={{
                    rotate: expandedCategoryKey === "transaction" ? 180 : 0,
                  }}
            ...
            >
              ...
              >
                ...
                <motion.div
                  animate={{
                    rotate: expandedCategoryKey === "property" ? 180 : 0,
                  }}
                  transition={{ type: "spring", stiffness: 350, damping: 25 }}
                >
                  <ChevronDown className="w-4 h-4 text-gray-500" />
                        ...
                        return (
                          <motion.button
                            ...
                            onClick={() =>
                              handleUpdate(
                                "propertyType",
                                filters.propertyType === pt.id ? "Any" : pt.id,
                              )
                            }
                            className={clsx(
                          ...
                          >
                            ...
                            <span
                              className={clsx(
                                ...
                                isSelected
                                  ? "text-white"
                                  : "text-gray-700 group-hover:text-[#17274C]",
                              )}
                            >
                              {pt.label}
                            </span>
            ...
            >
              ...
              >
                ...
                <motion.div
                  animate={{
                    rotate: expandedCategoryKey === "budget" ? 180 : 0,
                  }}
                  transition={{ type: "spring", stiffness: 350, damping: 25 }}
                >
                  <ChevronDown className="w-4 h-4 text-gray-500" />
          ...
          <div className="space-y-2.5">
            ...
            >
              ...
              >
                ...
                <motion.div
                  animate={{
                    rotate: expandedCategoryKey === "industry" ? 180 : 0,
                  }}
                  transition={{ type: "spring", stiffness: 350, damping: 25 }}
                >
                  <ChevronDown className="w-4 h-4 text-gray-500" />
              ...
              <div
                className={clsx(
                  ...
                  advancedOpen
                    ...
                    : "bg-gray-100 text-gray-600 group-hover:bg-amber-100/60 group-hover:text-[#17274C]",
                )}
              >
                  ...
                  {activeTab === "commercial" && (
                    ...
                    >
                      ...
                      >
                        ...
                        <motion.div
                          animate={{
                            rotate: expandedCategoryKey === "size" ? 180 : 0,
                          }}
                          transition={{
                            type: "spring",
                            stiffness: 350,

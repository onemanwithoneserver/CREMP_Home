  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      <button
        type="button"
        onClick={() => setOpen((o) => !o)}
        className="w-full flex items-center justify-between gap-2 px-3 py-2 bg-white dark:bg-[#0b1b42] dark:border-white/10 border border-[#e5e7eb] rounded-[4px] text-[12px] font-semibold text-[#0a1128] dark:text-white hover:border-[#d4af37]/60 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[#d4af37]/50 transition-colors"
        ...
        >
          ...
          <div className="p-2 border-b border-[#f0f1f3] shrink-0">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-7 pr-3 py-1.5 text-[11px] bg-[#f9fafb] border border-[#e5e7eb] rounded-[4px] placeholder-[#9ca3af] text-[#0a1128] dark:text-white focus:outline-none focus:ring-1 focus:ring-[#d4af37]/40 focus:border-[#d4af37]/60"
                style={{ fontFamily: 'Outfit, sans-serif' }}
              />
            </div>
          </div>
          ...
          <div className="overflow-y-auto scrollbar-hide">
            ...
            <button
              ...
              className={`w-full text-left px-3 py-2 text-[12px] font-semibold flex items-center gap-2 hover:bg-[#f9fafb] transition-colors ${value.city === null ? 'text-[#d4af37] bg-[#faf8f0]' : 'text-[#0a1128] dark:text-white'}`}
              style={{ fontFamily: 'Outfit, sans-serif' }}
            >
            ...
            {filtered.map((group) => (
              <div key={group.city}>
                ...
                <button
                  ...
                  className={`w-full text-left px-3 py-2 text-[12px] font-bold flex items-center gap-2 hover:bg-[#f9fafb] transition-colors border-t border-[#f0f1f3] ${value.city === group.city && !value.locality ? 'text-[#d4af37] bg-[#faf8f0]' : 'text-[#0a1128] dark:text-white'}`}
                  style={{ fontFamily: 'Outfit, sans-serif' }}
                >
      ...
      <div className="flex-1 relative overflow-hidden" style={{ background: 'linear-gradient(160deg,#e8edf5 0%,#dde4f0 40%,#e4e9f2 100%)' }}>
        ...
        <div className="absolute top-3 right-3 flex flex-col gap-1 z-10">
          <button
            ...
            aria-label="Zoom in"
            className="w-8 h-8 bg-white dark:bg-[#0b1b42] dark:border-white/10 rounded-[4px] flex items-center justify-center shadow-md border border-black/[0.07] hover:bg-[#f5f6f8] active:scale-95 transition-all"
          >
          ...
          <button
            ...
            className="w-8 h-8 bg-white dark:bg-[#0b1b42] dark:border-white/10 rounded-[4px] flex items-center justify-center shadow-md border border-black/[0.07] hover:bg-[#f5f6f8] active:scale-95 transition-all mt-1"
          >
  ...
  return (
    <>
      ...
      <div
        ...
        aria-modal="true"
        aria-label="Map View"
        className="absolute bottom-0 left-0 right-0 z-[101] bg-white dark:bg-[#0b1b42] dark:border-white/10 rounded-t-[12px] shadow-[0_-8px_40px_rgba(0,0,0,0.16)] flex flex-col overflow-hidden"
        style={{
          height: '88vh',
          maxHeight: '88vh',

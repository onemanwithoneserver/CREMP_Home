    ...
    >
      ...
      >
        <button
          ...
          className="absolute -top-3 -right-3 z-20 w-8 h-8 bg-white dark:bg-[#0b1b42] dark:border-white/10 rounded-lg shadow-xl border border-black/5 flex items-center justify-center hover:bg-gray-50 transition-all hover:scale-105 active:scale-95 focus:outline-none focus:ring-2 focus:ring-[#d4af37]"
        >
      ...
      >
        ...
        >
          ...
          <button
            ...
            onClick={onClose}
            aria-label="Close profile"
            className="absolute right-4 top-1/2 -translate-y-1/2 w-7 h-7 flex items-center justify-center bg-white dark:bg-[#0b1b42] dark:border-white/10 rounded-[4px] shadow-sm hover:bg-gray-100 transition-colors focus-visible:outline-none"
          >

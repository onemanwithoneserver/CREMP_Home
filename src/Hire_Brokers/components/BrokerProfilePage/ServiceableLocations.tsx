            ...
            return (
              ...
              >
                <div className="flex items-center gap-2 px-3 py-2 border-b border-[#0a1128]/[0.04] bg-[#0a1128]/[0.016]">
                  ...
                  />
                  <span className="text-[11px] font-bold text-[#0a1128] dark:text-white flex-1 font-['Outfit',sans-serif]">
                    {c.label}
                  </span>
          ...
          <div className={`relative overflow-hidden ${isDesktop ? 'min-h-[200px] flex-1' : 'h-[180px]'}`}>
            ...
            <div className="absolute top-2 right-2 flex flex-col gap-1 z-10">
              <button
                ...
                aria-label="Zoom in"
                className="w-6 h-6 bg-white dark:bg-[#0b1b42] dark:border-white/10 rounded flex items-center justify-center shadow-sm border border-black/[0.08] hover:bg-[#f5f6f8] transition-colors"
              >

      ...
      <Backdrop onClose={onClose}>
        <Sheet isDesktop={isDesktop} onClose={onClose}>
          <div className="flex flex-col items-center justify-center gap-3 py-8 px-4 text-center font-['Outfit',sans-serif] animate-in fade-in zoom-in-95 duration-300">
            ...
            <div>
              <p className="text-[16px] font-bold text-[#0a1128] dark:text-white">Consultation Scheduled!</p>
    ...
    <Backdrop onClose={onClose}>
      <Sheet isDesktop={isDesktop} onClose={onClose}>
        <div className="flex items-center justify-between px-3.5 pt-3.5 pb-2.5 border-b border-black/[0.06] font-['Outfit',sans-serif]">
          <div>
            <p className="text-[14px] font-bold text-[#0a1128] dark:text-white">Schedule Consultation</p>
        ...
        <div className="overflow-y-auto flex-1 px-3.5 py-2.5 space-y-4 font-['Outfit',sans-serif]">
          <div>
            <div className="flex items-center gap-1.5 mb-2">
              ...
              <p className="text-[12px] font-bold text-[#0a1128] dark:text-white">Meeting Type</p>
            </div>
          ...
          <div>
            <div className="flex items-center gap-1.5 mb-2">
              <span className="w-[3px] h-[12px] rounded-full bg-[#d4af37] shrink-0 block" />
              <p className="text-[12px] font-bold text-[#0a1128] dark:text-white">Select Date</p>
            </div>
            <div className="relative">
              {canScrollLeft && (
                <button
                  ...
                  className="absolute left-0 top-1/2 -translate-y-1/2 z-10 w-6 h-6 rounded-[4px] flex items-center justify-center focus-visible:outline-none bg-white dark:bg-[#0b1b42] dark:border-white/10 border border-[#0a1128]/[0.12] shadow-[0_2px_8px_rgba(0,0,0,0.12)] hover:scale-110 active:scale-90 transition-transform duration-200"
                >
                ...
                {days.map((day, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className={`text-[14px] font-bold leading-none ${active ? 'text-white' : 'text-[#0a1128] dark:text-white'}`}>
                        {day.getDate()}
                      </span>
              ...
              {canScrollRight && (
                <button
                  ...
                  className="absolute right-0 top-1/2 -translate-y-1/2 z-10 w-6 h-6 rounded-[4px] flex items-center justify-center focus-visible:outline-none bg-white dark:bg-[#0b1b42] dark:border-white/10 border border-[#0a1128]/[0.12] shadow-[0_2px_8px_rgba(0,0,0,0.12)] hover:scale-110 active:scale-90 transition-transform duration-200"
                >
          ...
          <div>
            <div className="flex items-center gap-1.5 mb-2">
              <span className="w-[3px] h-[12px] rounded-full bg-[#d4af37] shrink-0 block" />
              <p className="text-[12px] font-bold text-[#0a1128] dark:text-white">Available Times</p>
            </div>
                  ...
                  return (
                    <button
                      ...
                      className={`py-1 rounded-[4px] text-[10.5px] font-semibold border transition-all duration-200 focus-visible:outline-none disabled:opacity-35 disabled:cursor-not-allowed ${
                        active 
                          ? 'bg-[#d4af37] text-[#0a1128] dark:text-white border-[#d4af37] shadow-sm scale-105' 
                          : available 
                            ? 'bg-[#f5f6fa] text-[#0a1128] dark:text-white border-[#0a1128]/[0.09] hover:bg-[#0a1128]/5 hover:border-[#0a1128]/20 hover:-translate-y-[1px] hover:shadow-sm active:scale-95' 
          ...
          <div>
            <div className="flex items-center gap-1.5 mb-2">
              <span className="w-[3px] h-[12px] rounded-full bg-[#d4af37] shrink-0 block" />
              <p className="text-[12px] font-bold text-[#0a1128] dark:text-white">
            ...
            <textarea
              ...
              className="w-full resize-none rounded-[4px] border px-2.5 py-1.5 text-[11.5px] text-[#0a1128] dark:text-white placeholder:text-[#9ca3af] focus:outline-none focus:ring-2 focus:ring-[#0a1128]/20 focus:-translate-y-[1px] focus:shadow-sm transition-all duration-200 bg-[#f5f6fa] border-[#0a1128]/10 font-['Outfit',sans-serif]"
            />
          </div>
        </div>
...
function Sheet({ children, isDesktop, onClose }: { children: React.ReactNode; isDesktop: boolean; onClose: () => void }) {
  ...
  return (
    <div
      className={`w-full flex flex-col bg-white dark:bg-[#0b1b42] dark:border-white/10 overflow-hidden shadow-[0_24px_80px_rgba(10,17,40,0.28)] transition-transform duration-500 ease-out animate-in slide-in-from-bottom-8 ${
        isDesktop

                        ...
                        {showViewControls && (
                            ...
                            >
                                <button
                                    ...
                                    className={`flex items-center gap-2 px-4 py-1.5 rounded text-xs font-bold transition-base focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cremp-primary focus-visible:ring-offset-1 motion-reduce:transition-none ${viewMode === "desktop"
                                ...
                                <button
                                    ...
                                    className={`flex items-center gap-2 px-4 py-1.5 rounded text-xs font-bold transition-base focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cremp-primary focus-visible:ring-offset-1 motion-reduce:transition-none ${viewMode === "mobile"
                                            ? "gradient-primary text-white shadow-elevation-1"
                                            : "text-cremp-primary dark:text-cremp-text-secondary bg-transparent hover:bg-white/60 dark:hover:bg-cremp-surface-alt"
                                        }`}
                                >
                            ...
                            >
                                {(["desktop", "mobile"] as const).map((v) => (
                                    <button
                                        ...
                                        className={`w-8 h-8 flex items-center justify-center rounded border transition-base focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cremp-primary focus-visible:ring-offset-1 motion-reduce:transition-none ${viewMode === v
                        ...
                        <div className="relative sm:hidden" ref={mobileMenuRef}>
                            ...
                            >
                                ...
                                <ChevronDown
                                    size={12}
                                    aria-hidden="true"
                                    className={`text-cremp-text-muted transition-transform duration-200 motion-reduce:transition-none ${mobileMenuOpen ? "rotate-180" : ""
                                        }`}
                                />
                            </button>
                                    ...
                                    {(Object.keys(PAGE_LABELS) as Page[]).map((p) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`w-full text-left px-4 py-2.5 text-xs font-semibold transition-base focus-visible:outline-none focus-visible:bg-cremp-primary/10 motion-reduce:transition-none ${isActive

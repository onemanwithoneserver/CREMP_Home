                    ...
                    {idealPartnerData.criteria.map((item) => {
                        ...
                        return (
                            <motion.div
                                key={item.title}
                                variants={fadeInUp}
                                className={clsx("rounded-xl border p-4 shadow-sm hover-lift cursor-default transition-all duration-300 flex flex-col bg-white dark:bg-surface", getCardStyles(item.intent))}
                            >
                    ...
                    {idealPartnerData.additionalCriteria.map((item) => {
                        ...
                        return (
                            <motion.div
                                key={item.title}
                                variants={fadeInUp}
                                className={clsx("bg-white dark:bg-surface border border-gray-200 dark:border-border p-5 rounded-xl shadow-sm hover-lift cursor-default transition-all duration-300 flex flex-col hover:border-gray-300 dark:hover:border-gray-600")}
                            >

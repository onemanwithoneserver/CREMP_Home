                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex items-center gap-4 mb-6 relative z-10">
                                    <div className={clsx("w-14 h-14 rounded-lg flex shrink-0 items-center justify-center shadow-sm transition-transform duration-500 group-hover:scale-110 group-hover:rotate-3", getIconContainerStyles(item.intent))}>
                                    ...
                                    {item.items.map((subItem, idx) => (
                                        <div key={idx} className="flex items-start gap-3 group/item">
                                            <div className="mt-1 flex items-center justify-center w-5 h-5 rounded-full bg-gray-50 dark:bg-white/5 group-hover/item:bg-primary/10 transition-colors duration-300">
                                                <Check size={12} className={clsx("transition-colors duration-300", getBadgeStyles(item.intent).split(' ')[0], "group-hover/item:text-primary")} />
                                            </div>
                ...
                >
                    {idealPartnerData.singleSelects.map((item) => {
                        ...
                        return (
                            ...
                            >
                                <div className={clsx("w-12 h-12 rounded flex shrink-0 items-center justify-center shadow-sm transition-transform duration-500 group-hover:scale-110", getIconContainerStyles(item.intent))}>
                ...
                >
                    ...
                    >
                        ...
                        <div className="w-16 h-16 rounded-lg bg-white/10 flex items-center justify-center shrink-0 transition-transform duration-500 group-hover:scale-110 shadow-inner relative z-10">
                            <idealPartnerData.additionalExpectations.icon size={28} className="text-white" strokeWidth={1.5} />
                        </div>

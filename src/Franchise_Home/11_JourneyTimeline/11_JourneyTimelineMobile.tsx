          ...
          {journeyTimelineData.milestones.map((milestone, idx) => (
            ...
            >
              ...
              <motion.div
                ...
                className={`absolute -left-10 top-2 w-10 h-10 rounded-full flex items-center justify-center text-[11px] font-black z-10 ${
                  milestone.isActive
              ...
              <div
                className={`ml-6 border rounded-[4px] p-5 shadow-sm hover-lift cursor-default transition-all duration-500 relative overflow-hidden ${
                  milestone.isActive 
                    ? "bg-[#0a1128] border-[#d4af37]/40 shadow-md shadow-[#d4af37]/10" 

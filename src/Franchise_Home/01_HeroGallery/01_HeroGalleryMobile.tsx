                ...
                <motion.div variants={item} className="bg-white rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.08)] border border-gray-100 p-6 flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-3 mt-2 pt-6 border-t border-gray-200/60">
                        {[
                            ...
                            { icon: Globe, label: heroData.contactInfo.website, href: `https://${heroData.contactInfo.website}`, colors: "from-fuchsia-50 to-fuchsia-100 text-fuchsia-700 border-fuchsia-200", shadowColor: "rgba(217,70,239," },
                            { icon: MapPin, label: heroData.contactInfo.headquarters, href: "#", colors: "from-amber-50 to-amber-100 text-amber-700 border-amber-200", shadowColor: "rgba(245,158,11," },
                        ].map((item, idx) => {
                        ...
                        {/* Static Vibrant Social Icons Row */}
                        <div className="flex items-center gap-4 mt-4 pt-4 border-t border-gray-200/60 justify-center">
                            ...
                            <motion.a 
                                href={heroData.contactInfo.instagram ? `https://instagram.com/${heroData.contactInfo.instagram.replace('@', '')}` : '#'} 
                                target="_blank" 
                            ...
                            <motion.a 
                                href={heroData.contactInfo.linkedin ? `https://linkedin.com/company/${heroData.contactInfo.linkedin}` : '#'} 
                                target="_blank" 
                                rel="noopener noreferrer" 
                                animate={{ y: [0, -3, 0] }}
                            ...
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.32 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93h2.79M6.88 8.56a1.68 1.68 0 0 0 1.68-1.68c0-.93-.75-1.69-1.68-1.69a1.69 1.69 0 0 0-1.69 1.69c0 .93.76 1.68 1.69 1.68m1.39 9.94v-8.37H5.5v8.37h2.77z"/></svg>
                            </motion.a>
                        </div>
                    </div>
                </motion.div>

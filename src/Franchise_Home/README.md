...
| Element | Min Limits | Max Limits | Recommended | Notes |
| :--- | :--- | :--- | :--- | :--- |
| **Model Name** | 1 word / 4 chars | 3 words / 20 chars | **1 - 2 words** | E.g., "Kiosk", "Standalone". |
| **Price / Investment** | 3 chars (₹8L) | 12 chars (₹1.5Cr) | **~5 - 8 chars** | Keep concise for the UI badges. |
| **Area Required** | 8 chars (80 sq.ft) | 20 chars | **~15 chars** | E.g., "150 - 250 sq.ft". |
| **Ideal Location** | 1 word / 5 chars | 5 words / 35 chars | **2 - 3 words** | E.g., "Transit Hubs", "Premium Malls". |
| **Cost Breakdown Item** | 2 words / 10 chars | 4 words / 25 chars | **2 - 3 words** | E.g., "Setup & Interiors". |
| **Staff Role (Dialog)** | 1 word / 5 chars | 4 words / 25 chars | **2 - 3 words** | E.g., "Senior Barista", "Store Manager". |
...
| **ROI Percentage** | 3 chars (12%) | 10 chars (28-34%) | **~5 - 7 chars** | Projected range per year. |
| **Card Description** | 4 words / 25 chars | 12 words / 80 chars | **6 - 8 words** | E.g., "Built on initial footfall metrics". |
| **Card Sublabel** | 4 words / 25 chars | 12 words / 80 chars | **6 - 8 words** | E.g., "Typical for newly open". |
| **Payback Period Title** | 2 words / 10 chars | 4 words / 20 chars | **2 - 3 words** | E.g., "18–24 Months". |
| **Payback Subtitle** | 4 words / 20 chars | 12 words / 60 chars | **6 - 8 words** | E.g., "Target milestone for full recovery". |

## 4. Ideal Franchise Partner
...
| **Leader Bio (Dialog)** | 20 words / 130 chars | 80 words / 500 chars | **40 - 50 words** | Professional biography displayed in the modal. |
| **Leader Experience** | 5 chars (5 Yrs) | 15 chars (10+ Years) | **~10 chars** | Displayed as a badge in the dialog. |
| **Leader Quote (Dialog)** | 10 words / 60 chars | 30 words / 200 chars | **15 - 20 words** | A personal quote shown in the modal. |
| **Highlights (3 items)** | 2 words / 10 chars | 6 words / 40 chars | **3 - 4 words** | Bullet points showing key achievements. |

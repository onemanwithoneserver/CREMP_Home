...
export const CostBreakdownTable = ({
  ...
  return (
    <div className="w-full flex flex-col gap-3 pt-2 border-none h-full bg-transparent">
      <div className="grid grid-cols-12 text-[11px] font-semibold text-gray-400 uppercase tracking-widest pb-4 border-b border-gray-100/80 dark:border-gray-800">
      ...
      <div className="flex flex-col gap-6 mt-4 flex-1 overflow-y-auto scrollbar-hide">
        {data.map((item, idx) => {
          ...
          return (
            <div
              key={idx}
              className="grid grid-cols-12 items-center hover:bg-gray-50 dark:hover:bg-gray-800/50 rounded-xl transition-colors group cursor-pointer"
            >
              <div className="col-span-6 flex items-center gap-2">
                ...
                <span
                  className="text-[12px] font-semibold text-[#0b1b42] dark:text-gray-200 truncate pr-2 group-hover:text-primary transition-colors"
                  title={item.label}
                >
                  {item.label}
                </span>
              ...
              <div className="col-span-3 flex justify-center">
                <span className="text-[11px] font-semibold text-gray-500 bg-gray-100/80 dark:bg-gray-800 px-2.5 py-1 rounded-md">
                  {item.percentage}%
                </span>
              </div>
      ...
      <div className="grid grid-cols-12 items-center  pt-2 pb-2 ">
        ...
        <div className="col-span-5 text-right flex flex-col justify-center pr-2">
          <span className="text-xl font-semibold text-[#0b1b42] dark:text-white leading-none tracking-tight">
            {totalValue}
          </span>
        </div>
      </div>

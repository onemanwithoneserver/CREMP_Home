    ...
    <section className="w-full bg-background px-4 py-12">
      ...
      <div className="flex flex-col mb-8 text-center items-center">
        ...
        <motion.button
          ...
          className="flex items-center justify-center gap-2 w-full px-6 py-3.5 bg-primary hover:bg-primary/90 text-white rounded-[4px] text-sm font-bold shadow-sm transition-all hover-lift"
        >

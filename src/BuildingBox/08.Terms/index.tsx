                    ...
                    <div className="relative flex flex-col w-full z-10">
                        ...
                        >
                            {termsData.visibleItems.map((item, idx) => (
                                <motion.li key={idx} variants={listItemReveal} className="relative w-full group h-[64px] flex items-center">
                                    <div className="w-[76px] h-full flex items-center relative shrink-0">
                                        <div className={`w-10 h-10 ml-[12px] rounded-[4px] flex items-center justify-center relative z-20 shadow-[0_2px_10px_rgba(0,0,0,0.1)] text-white group-hover:scale-110 group-hover:shadow-[0_4px_15px_rgba(212,175,55,0.3)] transition-all duration-300 ${item.color}`}>

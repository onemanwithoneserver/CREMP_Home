    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="flex items-center justify-between p-3 border-b border-gray-100/80">
                    <div className="flex items-center gap-3.5">
                        ...
                        <div className="flex flex-col gap-0.5">
                            ...
                            <span className="text-[0.68rem] text-gray-500 font-medium leading-none">Seller-defined conditions</span>
                        </div>
                    </div>
                ...
                {/* Terms content */}
                <div className="px-3 py-4 flex flex-col gap-3 relative">
                    {/* Timeline line */}
                    ...
                    >
                        {termsData.visibleItems.map((item, idx) => (
                            <motion.li
                                ...
                                className="flex items-start gap-3 group cursor-default rounded-xl py-2 px-1 transition-all duration-300"
                            >
                                <motion.span
                                    initial={{ scale: 0 }}
                                    whileInView={{ scale: 1 }}
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.96 }}
                        className="flex items-center gap-1.5 font-bold text-[0.72rem] w-fit relative z-10 px-3 py-1.5 mt-1 rounded-full border border-[#d4af37]/30 bg-white text-[#d4af37] transition-all shadow-sm"
                    >
                    ...
                    {termsData.warning && (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="mt-3 flex items-start gap-3 bg-amber-50/70 border border-amber-200/60 rounded-xl p-3 backdrop-blur-sm relative z-10 shadow-sm"
                        >

...
import { Mail, Phone, Lock, Eye, EyeOff, Globe, ChevronDown } from 'lucide-react';
      ...
      <div className="flex-1 flex items-center justify-center p-4 relative z-10 pt-16">
        ...
        >
          ...
          <div className="mb-6 text-center">
            <h1 className="text-xl font-extrabold text-[#0a1128] dark:text-white mb-2">Welcome Back</h1>
            <p className="text-[13px] font-medium text-gray-500 dark:text-gray-400">Please enter your details to sign in.</p>
          </div>
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="flex items-center justify-between pt-1">
              <label className="flex items-center gap-1.5 cursor-pointer group">
                ...
                <span className="text-[12px] font-semibold text-gray-600 dark:text-gray-400 group-hover:text-[#0a1128] dark:group-hover:text-white transition-colors">Remember me</span>
              </label>
              <a href="#" className="text-[12px] font-bold text-[#d4af37] hover:text-[#b38728] transition-colors underline-offset-4 hover:underline">
                Forgot Password?
              </a>
            </div>
            <button className="w-full py-3 mt-3 bg-gradient-to-r from-[#bf953f] via-[#d4af37] to-[#b38728] text-white rounded-[8px] font-bold text-[14px] shadow-[0_8px_20px_rgba(212,175,55,0.3)] hover:shadow-[0_10px_25px_rgba(212,175,55,0.4)] transition-all hover:-translate-y-0.5 relative overflow-hidden group">
          ...
          <div className="relative mt-6 mb-6">
            ...
            <div className="relative flex justify-center text-[10px] font-bold uppercase tracking-widest">
              <span className="bg-white dark:bg-[#0b1b42] px-3 text-gray-400">Or continue with</span>
            </div>
          </div>
          <div className="grid grid-cols-3 gap-2">
            ...
            <button className="flex items-center justify-center gap-1.5 py-2.5 border border-gray-200 dark:border-white/10 rounded-[8px] hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group shadow-sm text-[12px] font-bold text-[#0a1128] dark:text-white">
              <svg className="w-3.5 h-3.5 group-hover:scale-110 transition-transform" viewBox="0 0 21 21">
            ...
            <button className="flex items-center justify-center gap-1.5 py-2.5 border border-gray-200 dark:border-white/10 rounded-[8px] hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group shadow-sm text-[12px] font-bold text-[#0a1128] dark:text-white">
              <svg className="w-3.5 h-3.5 group-hover:scale-110 transition-transform fill-[#0a1128] dark:fill-white" viewBox="0 0 24 24">

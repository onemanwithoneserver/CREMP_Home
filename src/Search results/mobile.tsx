  ...
  return (
    <div className="flex flex-col w-full h-full bg-white dark:bg-[#0b1b42] overflow-hidden font-sans transition-colors duration-300 relative">
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        <div
          className="absolute top-[-8%] left-[-12%] w-72 h-72 bg-[#d4af37]/5 dark:bg-[#d4af37]/8 rounded-full blur-3xl animate-float"
          style={{ animationDuration: "12s" }}
        />
        <div
          className="absolute bottom-[15%] right-[-10%] w-80 h-80 bg-[#c69a54]/4 dark:bg-[#c69a54]/8 rounded-full blur-3xl animate-float"
          style={{ animationDuration: "16s", animationDelay: "3s" }}
        />
      </div>

      <div
        className="flex-none px-3 pt-3 pb-0 relative z-40 pointer-events-none"
        style={{ marginBottom: showMap ? "-72px" : "4px" }}
      >
          ...
          <div className="absolute inset-y-1.5 right-1.5 flex gap-1 items-center">
            <motion.button
              ...
              className={clsx(
                ...
                showMap
                  ? "bg-gradient-to-br from-[#bf953f] to-[#d4af37] text-white shadow-[0_2px_8px_rgba(212,175,55,0.3)]"
                    ...
                    suggestions.map((f) => (
                      ...
                      >
                        ...
                        <div className="flex flex-col min-w-0">
                          <span className="truncate font-bold text-[13px] leading-tight text-[#0a1128] dark:text-white">
                            {f.name}
                          </span>
      ...
      <AnimatePresence>
        {showMap && (
          ...
          >
            <svg
              className="absolute inset-0 w-full h-full opacity-[0.06] dark:opacity-[0.04] pointer-events-none"
            ...
            >
              <path
                d="M 0,80 Q 100,120 200,60 T 400,130"
                fill="none"
                stroke="#64748b"
                strokeWidth="2"
                strokeDasharray="6 4"
              />
              <path
                d="M 30,180 Q 150,150 250,200 T 400,170"
                fill="none"
                stroke="#64748b"
                strokeWidth="1.5"
                strokeDasharray="4 6"
            ...
            {filtered.map((f, i) => {
              ...
              return (
                <motion.div
                  ...
                  onClick={() =>
                    setSelectedMarker(selectedMarker === f.id ? null : f.id)
                  }
                >
                  <motion.div
                  ...
                  >
                      ...
                      <>
                        <motion.div
                          className={clsx(
                            ...
                            `border-current ${meta.text} opacity-30`,
                          )}
                        ...
                        <motion.div
                          className={clsx(
                            "absolute w-12 h-12 rounded-full border",
                            `border-current ${meta.text} opacity-15`,
                          )}
                    ...
                    <div
                      className={clsx(
                        "w-9 h-9 rounded-[6px] flex items-center justify-center transition-all duration-200 shadow-md",
                        isActive
                          ? `${meta.bg} ${meta.glow}`
                  ...
                  return (
                    <motion.div
                      ...
                      style={{
                        ...
                        bottom:
                          f.lat >= 40 ? `calc(${100 - f.lat}% + 28px)` : "auto",
                        left: `max(12px, min(calc(${f.lng}% - 130px), calc(100% - 272px)))`,
                        width: "260px",
                        transformOrigin:
                          f.lat < 40 ? "top center" : "bottom center",
                      }}
                    ...
                    >
                      ...
                      <div className="p-3">
                        <div className="flex items-start justify-between mb-1">
                          <div className="flex gap-2.5 items-center min-w-0">
                            ...
                            <div className="min-w-0">
                              <h3 className="font-extrabold text-[13px] leading-tight truncate text-[#0a1128] dark:text-white">
                                {f.name}
                              </h3>
                          ...
                          <div className="flex items-center gap-0.5 shrink-0 ml-1">
                            <motion.button
                              ...
                              className="p-1 rounded-full hover:bg-gray-100 dark:hover:bg-white/10 transition-all"
                            >
                              <Heart
                                className={clsx(
                            ...
                            <motion.button
                              ...
                              className="p-1 rounded-full hover:bg-gray-100 dark:hover:bg-white/10 text-gray-400 hover:text-gray-600 dark:hover:text-white transition-all"
                            >
                        ...
                        <div className="flex items-center gap-1.5 mt-1.5 flex-wrap">
                          <span className="text-[10px] font-extrabold text-[#0b1b42] dark:text-[#d4af37]">
                            {f.investment}
                          </span>
                          ...
                          >
                            ...
                            <span className="relative z-10 flex items-center gap-1">
                              ...
                              <span className="relative flex items-center justify-center w-3 h-3 overflow-hidden">
                                <ArrowRight
                                  className="w-3 h-3 absolute -translate-x-[150%] opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-300 ease-out"
                                  strokeWidth={2.5}
                                />
                                <ArrowRight
                                  className="w-3 h-3 absolute translate-x-0 opacity-100 group-hover:translate-x-[150%] group-hover:opacity-0 transition-all duration-300 ease-out"
                                  strokeWidth={2.5}
                                />
                              </span>
                            </span>
                  ...
                  <div className="flex gap-3">
                    <div
                      className={clsx(
                        ...
                        isActive
                          ...
                          : "border-gray-200/80 dark:border-gray-700/60 shadow-sm",
                      )}
                    >
                      <img
                        src={f.logo}
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-1.5 flex-wrap">
                        <span className="text-[11px] font-extrabold text-[#0b1b42] dark:text-[#d4af37]">
                          {f.investment}
                        </span>
                    ...
                    <div className="flex items-center gap-1.5 flex-wrap min-w-0">
                      {f.tags.slice(0, 2).map((tag) => (
                        <span
                          key={tag}
                          className={clsx(
                            "px-2 py-0.5 rounded-[4px] text-[8px] font-bold border tracking-wide",
                            tagColors[tag] ||
                              "bg-gray-100 dark:bg-white/5 text-gray-500 border-gray-200/60 dark:border-white/10",
                          )}
                        >
                          {tag}
                        </span>
                    ...
                    >
                      ...
                      <span className="relative z-10 flex items-center gap-1">
                        ...
                        <span className="relative flex items-center justify-center w-3.5 h-3.5 overflow-hidden">
                          <ArrowRight
                            className="w-3.5 h-3.5 absolute -translate-x-[150%] opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-300 ease-out"
                            strokeWidth={2.5}
                          />
                          <ArrowRight
                            className="w-3.5 h-3.5 absolute translate-x-0 opacity-100 group-hover:translate-x-[150%] group-hover:opacity-0 transition-all duration-300 ease-out"
                            strokeWidth={2.5}
                          />
                        </span>
                      </span>

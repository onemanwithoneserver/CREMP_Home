    ...
    >
      ...
      <div className="flex items-center gap-3.5 mb-4">
        ...
        <div className="min-w-0 pr-6">
          <h4 className="font-bold text-[#0a1128] dark:text-white text-[15px] leading-tight truncate mb-1">
            {franchise.name}
          </h4>
      ...
      <div className="flex items-center justify-between gap-2">
        <div
          className={clsx(
            "flex items-center gap-1.5 px-3 py-1.5 rounded-[6px] text-[11px] font-bold shadow-sm",
            meta.bg,
            meta.text,
          )}
        >
    ...
    <div className="flex flex-row w-full h-full bg-white dark:bg-[#0b1b42] overflow-hidden font-sans transition-colors duration-300">
      ...
      <div className="w-[65%] h-full flex flex-col relative border-r border-gray-200/60 dark:border-gray-800 z-10 bg-white dark:bg-[#0b1b42]">
        <div className="flex-1 relative bg-gradient-to-br from-[#eef2f6] via-[#e8edf4] to-[#dfe5ee] dark:from-[#0a1128] dark:via-[#0d1730] dark:to-[#0a1128] overflow-hidden">
                          ...
                          {displayFranchises.length > 0 ? (
                            displayFranchises.map((f) => (
                              <div
                                ...
                                className="px-4 py-3.5 hover:bg-slate-50 dark:hover:bg-white/5 cursor-pointer rounded-[8px] text-slate-800 dark:text-slate-200 flex items-center gap-4 transition-all duration-200 mx-1 my-0.5 group"
                              >
                                ...
                                <div className="flex flex-col min-w-0 justify-center">
                                  <span className="truncate font-semibold text-[14px] leading-tight tracking-tight text-[#0a1128] dark:text-white">
                                    {f.name}
                                  </span>
          ...
          >
            <path
              d="M 0,120 Q 200,180 400,100 T 800,200"
              fill="none"
              stroke="#64748b"
              strokeWidth="2"
              strokeDasharray="8 6"
            />
            <path
              d="M 50,300 Q 250,250 450,350 T 800,280"
              fill="none"
              stroke="#64748b"
              strokeWidth="1.5"
              strokeDasharray="5 7"
          ...
          <div className="absolute bottom-5 right-5 flex flex-col gap-1.5 z-10">
            {["+", "−"].map((label) => (
              <motion.button
                ...
                className="glass w-9 h-9 flex items-center justify-center rounded-[4px] text-gray-600 dark:text-gray-300 text-lg font-medium hover:text-[#d4af37] transition-colors"
              >
                {label}
              </motion.button>
            ))}
                      ...
                      <div className="flex items-center gap-1.5 flex-wrap min-w-0">
                        {f.tags.slice(0, 2).map((tag) => (
                          <span
                            key={tag}
                            className={clsx(
                              "px-2 py-0.5 rounded-[4px] text-[9px] font-semibold border",
                              tagColors[tag] ||

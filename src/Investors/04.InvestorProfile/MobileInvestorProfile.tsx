                    ...
                    <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} exit={{ height: 0, opacity: 0 }} className="bg-gray-50 dark:bg-[#0a1128]">
                      <div className="p-4 flex flex-col gap-4">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className="font-bold text-gray-900 dark:text-white text-[0.85rem] uppercase tracking-wide">{investorProfileData.expectationsTitle}</span>
                        </div>
                        {investorProfileData.expectations.map((exp, eIdx) => (

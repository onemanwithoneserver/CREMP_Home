  ...
  return (
    <div className="relative w-full overflow-hidden bg-white px-4 py-16 transition-colors duration-700 dark:bg-[#0a1128]">
      <motion.div variants={staggerContainer} initial="hidden" whileInView="show" viewport={{ once: true }} className="relative z-10 flex flex-col items-center">
        ...
        <motion.div variants={fadeInUp} className="w-full rounded-[8px] bg-gray-50 p-6 shadow-inner dark:bg-[#0a101d] border border-gray-100 dark:border-gray-800 mb-8 transition-all duration-300 hover:shadow-lg hover:border-[#D4AF37]/50">
          ...
          <div className="flex flex-col gap-3">
            {testimonialsData.benefits.map((benefit, idx) => (
              <div key={idx} className="flex items-center gap-3 rounded-[8px] bg-white p-4 shadow-sm dark:bg-[#0a1128] border border-gray-100 dark:border-gray-800 transition-all duration-300 hover:shadow-lg hover:border-[#D4AF37]/50">
        ...
        <motion.div variants={fadeInUp} className="flex w-full flex-col gap-3">
          ...
          <button className="flex w-full items-center justify-center gap-2 rounded-[8px] border border-gray-200 bg-white py-4 text-[0.9rem] font-bold text-gray-900 shadow-sm dark:border-gray-800 dark:bg-gray-900/50 dark:text-white">
            <Btn2Icon size={18} className="text-[#D4AF37] dark:text-[#D4AF37]" />

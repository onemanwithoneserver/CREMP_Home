...
export const testimonialsData = {
  ...
  buttons: [
    { icon: Rocket, title: 'Join CREMP Now', subtitle: 'Secure your early access spot. Start exploring opportunities.' },
    { icon: CalendarDays, title: 'Schedule\nDiscovery Call' }
  ],
  bottomDisclaimer: 'Limited early access spots available for investors across India.'
};

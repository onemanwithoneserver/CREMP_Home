...
import { Camera, CheckCircle2, User, ShieldCheck, Briefcase } from "lucide-react";
      ...
      <div className="w-full max-w-5xl flex flex-col md:flex-row gap-6">
        <div className="w-full md:w-1/3 flex flex-col gap-5">
          <div className="sticky top-20 flex flex-col gap-5">
            ...
            >
              <div className="w-24 h-24 mt-2 rounded-full bg-gradient-to-br from-[#0b1b42] to-[#121c33] text-[#d4af37] flex items-center justify-center text-4xl font-semibold border-4 border-[#d4af37]/30 shadow-xl shadow-[#d4af37]/10 relative group hover:border-[#d4af37]/60 transition-colors duration-500">
                A
                <div className="absolute inset-0 rounded-full border border-[#d4af37]/20 m-1" />
              </div>
              <div className="flex flex-col items-center mt-2">
                <h2 className="text-2xl font-semibold text-[#0a1128] dark:text-white tracking-tight">{formData.fullName || "Your Name"}</h2>
                <div className="mt-2 flex items-center gap-1 px-4 py-1.5 bg-gradient-to-r from-[#d4af37]/10 to-[#bf953f]/10 border border-[#d4af37]/20 rounded-full shadow-sm">
                  <span className="text-[10px] font-semibold text-[#b8942b] dark:text-[#d4af37] uppercase tracking-widest">{formData.userType} • {formData.role}</span>
                </div>
              </div>
              ...
              <button
                onClick={handleSave}
                className="w-full max-w-[240px] mt-2 py-3.5 rounded-[4px] font-semibold text-[14px] flex items-center justify-center gap-2 transition-all bg-[#0b1b42] text-white hover:bg-[#121928] shadow-md shadow-[#0a1128]/25 border border-[#d4af37]/30"
              >
        ...
        <div className="w-full md:w-2/3 flex flex-col gap-5">
          ...
          >
            <div className="flex items-center gap-2.5 border-b border-gray-100 dark:border-gray-800 pb-3">
              ...
              <h3 className="font-semibold text-xs tracking-widest text-[#0a1128] dark:text-white uppercase">Identity & Authentication</h3>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="flex flex-col gap-1">
                <label className="text-[12px] font-semibold text-[#0a1128] dark:text-white">Date of Birth</label>
                <div className="flex gap-2">
                  <ModernDatePicker 
                    ...
                    className="flex-1"
                  />
                  <button className="px-5 rounded-[4px] bg-[#0b1b42] text-white font-semibold text-[12px] hover:bg-[#121928] transition-colors border border-[#d4af37]/30 shadow-md shadow-[#0a1128]/25 shrink-0 h-[42px]">
                    Verify
                  </button>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="border border-gray-200 dark:border-gray-700 rounded-[4px] p-2 bg-gray-50 dark:bg-[#0b1b42]/30 flex items-center justify-between gap-2 h-[46px] pl-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[12px] font-semibold text-[#0a1128] dark:text-white">Biometric Check</span>
                  </div>
                  <button className="px-3.5 h-full bg-[#0b1b42] rounded-[4px] text-white text-[11px] font-semibold hover:bg-[#121928] transition-colors border border-[#d4af37]/30">
                    Verify
                  </button>
                </div>
              </div>
          ...
          >
            <div className="flex items-center gap-2.5 border-b border-gray-100 dark:border-gray-800 pb-3">
              ...
              <h3 className="font-semibold text-xs tracking-widest text-[#0a1128] dark:text-white uppercase">Role & Business Details</h3>
            </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {(["Buyer", "Seller"] as const).map((type) => (
                    <button
                      ...
                      className={clsx(
                        "py-3 rounded-[4px] flex items-center justify-center gap-2 transition-all font-semibold text-[13px]",

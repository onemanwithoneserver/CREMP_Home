                            ...
                            {marketData.hexagons.map((hex, idx) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            <div
                                                className={`flex flex-col items-center rounded-[4px] px-2.5 py-1.5 text-[0.65rem] font-bold shadow-xl backdrop-blur-md ${isGold
                                        ...
                                        <motion.div
                                            ...
                                            initial="animate"
                                            className={`absolute -translate-x-1/2 -translate-y-1/2 group relative flex h-8 w-8 cursor-pointer items-center justify-center rounded-full border shadow-lg backdrop-blur-md transition-transform duration-300 hover:scale-110 ${isGold

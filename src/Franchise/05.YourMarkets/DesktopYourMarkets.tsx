              ...
              {marketData.hexagons.map((hex, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <div
                        className={`flex flex-col items-center rounded-[4px] px-3 py-1.5 text-xs font-bold shadow-xl backdrop-blur-md ${
                          isGold

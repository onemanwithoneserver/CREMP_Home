...
export const marketData = {
  ...
  hexagons: [
    { title: 'Financial District', status: 'Active Campaign', color: 'blue', icon: Store, position: { top: '35%', left: '20%' } },
    { title: 'Hi-Tech City', status: 'Active Campaign', color: 'blue', icon: Store, position: { top: '20%', left: '48%' } },
    { title: 'Kukatpally', status: 'Active Campaign', color: 'blue', icon: Store, position: { top: '15%', left: '75%' } },
    { title: 'Uppal Corridor', status: 'Upcoming Campaign', color: 'gold', icon: Store, position: { top: '35%', right: '10%' } },
    { title: 'Existing Outlet', status: 'Strengthening Presence', color: 'gray', icon: Store, position: { top: '55%', left: '55%' } }
  ],
  ...
  benefits: [
    ...
    { icon: TrendingUp, text: 'Improve enquiry quality while making every marketing rupee work harder' }
  ],
  outcome: {
    tag: 'OUTCOME',

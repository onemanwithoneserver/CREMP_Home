          ...
          >
            <motion.div variants={fadeInUp}>
              <motion.div
                ...
                className="mb-4 flex w-fit cursor-pointer items-center gap-2 rounded-[2px] border border-[#D4AF37]/30 bg-[#D4AF37]/10 px-4 py-1.5 shadow-sm backdrop-blur-xl dark:border-[#D4AF37]/30 dark:bg-[#D4AF37]/10"
              >
              ...
              return (
                ...
                >
                  <motion.div
                    ...
                    transition={{ duration: 0.3 }}
                    className={`mb-6 flex h-12 w-12 cursor-pointer items-center justify-center rounded-full shadow-sm ${
                      isGold

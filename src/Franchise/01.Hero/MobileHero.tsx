...
export default function MobileHero() {
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-[8px] bg-gray-50 py-10 shadow-2xl transition-colors duration-700 dark:bg-[#030712] dark:shadow-none">
      <motion.div 
        ...
        <div className="flex flex-col items-center gap-10 text-center">
          ...
          <motion.div variants={staggerContainer} initial="hidden" animate="show" className="flex w-full flex-col items-center">
            ...
            <motion.div variants={fadeInUp}>
              <span className="mb-4 flex items-center justify-center gap-2 rounded-[2px] border border-[#B27F1C]/20 bg-white/60 px-4 py-1.5 text-[10px] font-bold uppercase tracking-widest text-[#B27F1C] shadow-sm backdrop-blur-xl dark:border-[#F6B23B]/20 dark:bg-[#F6B23B]/5 dark:text-[#F6B23B]">
                {heroData.tag}
              </span>
            </motion.div>
            ...
            <motion.h1 
              variants={fadeInUp}
              className="mb-6 text-[2.5rem] font-black leading-[1.1] tracking-tight text-gray-900 dark:text-white sm:text-[3rem]"
            >
            ...
            <motion.p variants={fadeInUp} className="mb-8 w-full px-2 text-[0.95rem] leading-relaxed text-gray-600 dark:text-gray-400">
            ...
            <motion.div variants={fadeInUp} className="mb-10 flex w-full flex-col items-center gap-4 sm:flex-row sm:justify-center">
              <motion.button 
                whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}
                className="group flex w-full max-w-[280px] items-center justify-center gap-3 rounded-[4px] bg-gradient-to-r from-[#B27F1C] to-[#d49924] px-6 py-3.5 text-[0.95rem] font-bold text-white shadow-[0_8px_20px_rgba(178,127,28,0.2)] transition-all dark:from-[#F6B23B] dark:to-[#d49924] dark:text-[#030712] dark:shadow-[0_8px_20px_rgba(246,178,59,0.2)]"
              >
              ...
              <motion.button 
                whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}
                className="group flex w-full max-w-[280px] items-center justify-center gap-3 rounded-[4px] border border-gray-200 bg-white/80 px-6 py-3.5 text-[0.95rem] font-bold text-gray-900 shadow-sm backdrop-blur-md transition-all dark:border-gray-800 dark:bg-gray-900/50 dark:text-white"
              >
            ...
            <motion.div variants={fadeInUp} className="flex w-full flex-col gap-3 px-4">
              {heroData.features.map((feature, idx) => (
                <div key={idx} className="flex items-center gap-3 rounded-[4px] bg-white/50 p-2.5 dark:bg-gray-800/30">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-gray-100 bg-white text-[#B27F1C] shadow-sm dark:border-gray-700 dark:bg-[#0a101d] dark:text-[#F6B23B]">
          ...
          <div className="relative mt-8 flex h-[350px] w-full items-center justify-center">
            <motion.div 

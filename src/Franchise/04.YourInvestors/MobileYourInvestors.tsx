          ...
          >
            <div className="mb-8 flex flex-col items-center gap-4">
              <motion.div
                ...
                className="flex h-12 w-12 shrink-0 cursor-pointer items-center justify-center rounded-full border border-white/50 bg-white/50 shadow-[0_4px_12px_rgba(0,0,0,0.05)] backdrop-blur-md dark:border-white/10 dark:bg-black/40"
              >
                <Activity
                  size={20}
          ...
          >
            ...
            <div className="relative flex h-36 w-36 items-center justify-center">
              ...
              <motion.div
                ...
                className="relative z-20 flex h-14 w-14 cursor-pointer items-center justify-center rounded-full bg-gradient-to-tr from-[#D4AF37] to-[#b38728] shadow-[0_0_30px_rgba(178,127,28,0.6)] dark:from-[#D4AF37] dark:to-[#f9d08b]"
              >
                <Target
                  size={24}

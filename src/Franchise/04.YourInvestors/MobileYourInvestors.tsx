...
export default function MobileYourInvestors() {
  return (
    <div className="w-full bg-[#ffffff] pt-12 pb-12 px-5 overflow-hidden relative">
      ...
      >
        <p className="text-[0.95rem] text-[#3A4566] font-medium leading-relaxed">{investorData.desc[0]}</p>
        <p className="text-[0.95rem] text-[#2A3A69] font-bold leading-relaxed">{investorData.desc[1]}</p>
      </motion.div>
         ...
         >
           ...
           <div className="absolute top-1/2 left-[45%] -translate-x-1/2 -translate-y-1/2 w-48 bg-white/95 backdrop-blur-sm rounded-lg shadow-xl p-3 border border-[#E2E6EE] scale-110">
              <div className="flex items-center justify-between mb-2 border-b border-[#E2E6EE] pb-2">
                 <span className="font-bold text-[#2A3A69] text-[0.55rem]">Investor Enquiry</span>
              ...
              <div className="flex gap-2 items-center">
                 <div className="flex flex-col items-center shrink-0">
                    <span className="text-[0.45rem] font-bold text-[#6B7491] mb-1">Score</span>
                 ...
                 <div className="flex flex-col flex-1 pl-1">
                    <div className="flex flex-col gap-1">
                       <div className="flex items-center gap-1 text-[0.45rem] font-bold text-[#2A3A69]">
         ...
         >
            {investorData.pills.map((pill, idx) => (
              <div key={idx} className="flex items-center gap-2">
                 <div className="w-6 h-6 rounded-full bg-[rgba(199, 154, 23, 0.05)] flex items-center justify-center shrink-0 border border-[rgba(199, 154, 23, 0.15)] text-[#d97706]">
                   <pill.icon size={10} strokeWidth={2} />
                 </div>
                 <span className="text-[0.6rem] font-bold text-[#3A4566] whitespace-nowrap pr-1">
                   {pill.label}
                 </span>
              </div>
            ))}
      ...
      <div className="w-full bg-[rgba(199, 154, 23, 0.05)] rounded-2xl border border-[rgba(199, 154, 23, 0.15)] p-5 shadow-sm mb-6">
         <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-full bg-[#2A3A69] flex items-center justify-center text-white shrink-0 shadow-md">
              ...
              <div key={idx} className="flex gap-3">
                 ...
                 <div className="flex flex-col pb-2">
                    <div className="flex items-center gap-2 mb-1">
                       <item.icon size={16} className="text-[#2A3A69]" strokeWidth={1.5} />
                       <span className="font-bold text-[#2A3A69] text-[0.85rem]">{item.title}</span>
                    </div>
                    <p className="text-[0.7rem] text-[#6B7491] font-medium leading-relaxed">
                       {item.desc}
                    </p>
                 </div>
              </div>
      ...
      >
         ...
         <div className="flex items-center justify-center gap-2 mb-4">
            <div className="w-8 h-8 rounded-full bg-[#2A3A69] flex items-center justify-center text-white shrink-0 shadow-md">
         ...
         <h3 className="text-[1.3rem] font-black text-[#2A3A69] leading-[1.2] mb-8">

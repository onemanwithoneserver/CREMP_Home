      ...
      <Container className="relative z-10">
        <div className="mb-8 flex flex-col items-center gap-6 text-center">
          ...
          <div className="relative mt-4 -my-5 flex h-[400px] w-full items-center justify-center scale-90 sm:scale-100">
              ...
              {investorData.pills.map((pill, idx) => {
                ...
                return (
                  <motion.div
                    ...
                    className="absolute flex items-center gap-1.5 rounded-full border border-gray-200/60 bg-white/70 px-2 py-1 shadow-sm backdrop-blur-md dark:border-gray-800/60 dark:bg-gray-900/70"
                    style={positions[idx]}
                  >
                    ...
                    <span className="text-[0.5rem] font-bold uppercase tracking-widest text-gray-500 dark:text-gray-400">
                      {pill.label}
                    </span>
                  </motion.div>
                );
            ...
            <motion.div
              ...
              className="relative z-30 flex h-24 w-24 flex-col items-center justify-center rounded-[2rem] border border-[#D4AF37]/30 bg-white/90 shadow-[0_0_40px_rgba(178,127,28,0.2)] backdrop-blur-md dark:border-[#D4AF37]/30 dark:bg-[#0a101d]/90"
            >
              <YourBrandLogo size="md" stacked={true} />
              <motion.div
                variants={pulseRing}
                initial="animate"
                className="absolute -inset-3 -z-10 rounded-[2.5rem] border border-[#D4AF37]/30 dark:border-[#D4AF37]/30"
              />
              <motion.div
                variants={pulseRing}
                initial="animate"
                transition={{ delay: 1 }}
                className="absolute -inset-6 -z-10 rounded-[3rem] border border-[#D4AF37]/15 dark:border-[#D4AF37]/15"
              />
            </motion.div>
            ...
            <motion.div
              ...
              whileInView="animate"
              viewport={{ once: true }}
              className="absolute right-[5%] top-[10%] z-30 flex w-[180px] flex-col rounded-[8px] border border-gray-200/80 bg-white/95 p-3 backdrop-blur-md dark:border-gray-700/80 dark:bg-[#111827]/95"
            >
              <div className="mb-2 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="text-[0.55rem] font-bold uppercase text-gray-500 dark:text-gray-400">
                      Verified
                    </div>
                    <div className="text-[0.65rem] font-black text-gray-900 dark:text-white">
                      Inv-8842
                    </div>
                  </div>
                </div>
                <div className="flex h-6 w-6 items-center justify-center rounded-full bg-emerald-100 text-[0.55rem] font-black text-emerald-600 ring-1 ring-emerald-500/20 dark:bg-emerald-900/40 dark:text-emerald-400">
                  98%
                </div>
              </div>
              <div className="flex flex-wrap gap-1">
                <span className="rounded-[2px] border border-gray-100 bg-gray-50 px-1.5 py-0.5 text-[0.55rem] font-bold text-gray-600 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 transition-all duration-300 hover:shadow-lg hover:border-[#D4AF37]/50">
                  ₹5Cr+ Budget
                </span>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              whileInView="animate"
              viewport={{ once: true }}
              className="absolute bottom-[10%] right-[5%] z-30 flex w-[180px] flex-col rounded-[8px] border border-gray-200/80 bg-white/95 p-3 backdrop-blur-md dark:border-gray-700/80 dark:bg-[#111827]/95"
            >
              <div className="mb-2 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="flex h-6 w-6 items-center justify-center rounded-full bg-purple-100 text-purple-600 dark:bg-purple-900/40 dark:text-purple-400">
                    <User size={12} />
                  </div>
                  <div>
                    <div className="text-[0.55rem] font-bold uppercase text-gray-500 dark:text-gray-400">
            ...
            <motion.div
              ...
              whileInView="animate"
              viewport={{ once: true }}
              className="absolute bottom-[15%] left-[0%] z-30 flex w-[180px] flex-col rounded-[8px] border border-[#D4AF37]/40 bg-gradient-to-b from-white to-[#D4AF37]/10 p-3 backdrop-blur-md dark:border-[#D4AF37]/40 dark:from-gray-800 dark:to-[#D4AF37]/15"
            >
              ...
              <div className="mb-2 mt-2 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="flex h-6 w-6 items-center justify-center rounded-full bg-orange-100 text-orange-600 dark:bg-orange-900/40 dark:text-orange-400">
                    <User size={12} />
                  </div>
                  <div className="text-[0.65rem] font-black text-gray-900 dark:text-white">
                    Inv-7723
                ...
                <div className="flex h-6 w-6 items-center justify-center rounded-full bg-[#D4AF37]/20 text-[0.55rem] font-black text-[#D4AF37] ring-1 ring-[#D4AF37]/40 dark:bg-[#D4AF37]/20 dark:text-[#D4AF37] dark:ring-[#D4AF37]/40">
                  88%
                </div>
              </div>
              <div className="flex flex-wrap gap-1">
                <span className="rounded-[2px] border border-[#D4AF37]/20 bg-white/50 px-1.5 py-0.5 text-[0.55rem] font-bold text-gray-700 dark:border-[#D4AF37]/20 dark:bg-gray-900/50 dark:text-gray-300">
                  Multi-Unit
                </span>
              </div>
            </motion.div>
        ...
        <div className="grid grid-cols-1 gap-6">
          <motion.div
            ...
            className="flex flex-col items-center rounded-[8px] border border-gray-200/50 bg-gray-50 p-6 text-center shadow-md dark:border-gray-800/50 dark:bg-[#0a101d]"
          >
            <div className="mb-8 flex flex-col items-center gap-4">
              ...
              <h3 className="text-xl font-black font-sans text-gray-900 dark:text-white">
            ...
            <div className="flex flex-col gap-6">
              {investorData.expectations.map((item, idx) => (
                <div
                  key={idx}
                  className="flex flex-col items-center gap-3 rounded-[4px] bg-white p-4 shadow-sm dark:bg-[#030712]/50 text-center border border-gray-100 dark:border-gray-800 transition-all duration-300 hover:shadow-lg hover:border-[#D4AF37]/50"
                >
          ...
          <motion.div
            ...
            className="relative flex flex-col items-center justify-center overflow-hidden rounded-[8px] bg-gradient-to-b from-[#0f172a] to-[#030712] p-8 text-center shadow-xl ring-1 ring-white/10 dark:from-[#1e293b] dark:to-[#0a101d]"
          >
            ...
            <div className="relative z-10 mb-8 flex flex-col items-center">
              ...
              <h3 className="text-xl font-black font-sans leading-tight text-white">

...
export default function MobileYourInvestors() {
  return (
    <div className="relative w-full overflow-hidden rounded-[8px] bg-white py-4 shadow-xl transition-colors duration-700 dark:bg-[#030712] dark:shadow-none">
      ...
      <motion.div animate={{ opacity: [0.3, 0.6, 0.3], scale: [1, 1.05, 1] }} transition={{ duration: 8, repeat: Infinity }} className="pointer-events-none absolute right-[-10%] top-0 h-[400px] w-[400px] bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#D4AF37]/10 via-transparent to-transparent dark:from-[#D4AF37]/10" />
        ...
        <div className="mb-8 flex flex-col items-center gap-6 text-center">
          ...
          <div className="relative mt-4 -my-5 flex h-[400px] w-full items-center justify-center scale-90 sm:scale-100">
                ...
                return (
                  <motion.div key={idx} animate={{ y: [-8, 8, -8] }} transition={{ duration: 4 + idx, repeat: Infinity, ease: 'easeInOut' }} className="absolute flex items-center gap-1.5 rounded-full border border-gray-200/60 bg-white/70 px-2 py-1 shadow-sm backdrop-blur-md dark:border-gray-800/60 dark:bg-gray-900/70" style={positions[idx]}>
                    <div className="flex items-center justify-center rounded-full bg-[#D4AF37]/10 p-1 dark:bg-[#D4AF37]/10">
                      <pill.icon size={10} className="text-[#D4AF37] dark:text-[#D4AF37]" />
                    </div>
            ...
            <svg className="pointer-events-none absolute inset-0 z-20 h-full w-full">
               <motion.line x1="50%" y1="50%" x2="80%" y2="20%" stroke="currentColor" strokeWidth="2" strokeDasharray="4 4" className="text-[#D4AF37]/40 dark:text-[#D4AF37]/40" variants={drawLine} initial="hidden" whileInView="show" viewport={{ once: true }} />
               <motion.circle initial={{ scale: 0 }} whileInView={{ scale: 1 }} transition={{ delay: 2.2 }} cx="80%" cy="20%" r="3" className="fill-[#D4AF37] dark:fill-[#D4AF37]" />
               
               <motion.line x1="50%" y1="50%" x2="75%" y2="75%" stroke="currentColor" strokeWidth="2" strokeDasharray="4 4" className="text-[#D4AF37]/40 dark:text-[#D4AF37]/40" variants={drawLine} initial="hidden" whileInView="show" viewport={{ once: true }} />
               <motion.circle initial={{ scale: 0 }} whileInView={{ scale: 1 }} transition={{ delay: 2.2 }} cx="75%" cy="75%" r="3" className="fill-[#D4AF37] dark:fill-[#D4AF37]" />
               
               <motion.line x1="50%" y1="50%" x2="20%" y2="70%" stroke="currentColor" strokeWidth="2" strokeDasharray="4 4" className="text-[#D4AF37]/40 dark:text-[#D4AF37]/40" variants={drawLine} initial="hidden" whileInView="show" viewport={{ once: true }} />
               <motion.circle initial={{ scale: 0 }} whileInView={{ scale: 1 }} transition={{ delay: 2.2 }} cx="20%" cy="70%" r="3" className="fill-[#D4AF37] dark:fill-[#D4AF37]" />
            </svg>

            <motion.div initial={{ scale: 0 }} whileInView={{ scale: 1 }} viewport={{ once: true }} transition={{ type: 'spring', bounce: 0.5, delay: 0.2 }} className="relative z-30 flex h-24 w-24 flex-col items-center justify-center rounded-[2rem] border border-[#D4AF37]/30 bg-white/90 shadow-[0_0_40px_rgba(178,127,28,0.2)] backdrop-blur-md dark:border-[#D4AF37]/30 dark:bg-[#0a101d]/90">
              <YourBrandLogo size="md" stacked={true} />
              <motion.div variants={pulseRing} initial="animate" className="absolute -inset-3 -z-10 rounded-[2.5rem] border border-[#D4AF37]/30 dark:border-[#D4AF37]/30" />
              <motion.div variants={pulseRing} initial="animate" transition={{ delay: 1 }} className="absolute -inset-6 -z-10 rounded-[3rem] border border-[#D4AF37]/15 dark:border-[#D4AF37]/15" />
            </motion.div>
            ...
            <motion.div variants={floatGlow} initial="hidden" whileInView="animate" viewport={{ once: true }} className="absolute right-[5%] top-[10%] z-30 flex w-[180px] flex-col rounded-[8px] border border-gray-200/80 bg-white/95 p-3 backdrop-blur-md dark:border-gray-700/80 dark:bg-[#111827]/95">
              ...
              <div className="flex flex-wrap gap-1"><span className="rounded-[2px] border border-gray-100 bg-gray-50 px-1.5 py-0.5 text-[0.55rem] font-bold text-gray-600 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 transition-all duration-300 hover:shadow-lg hover:border-[#D4AF37]/50">₹5Cr+ Budget</span></div>
            </motion.div>
            ...
            <motion.div variants={floatGlow} initial="hidden" whileInView="animate" viewport={{ once: true }} className="absolute bottom-[10%] right-[5%] z-30 flex w-[180px] flex-col rounded-[8px] border border-gray-200/80 bg-white/95 p-3 backdrop-blur-md dark:border-gray-700/80 dark:bg-[#111827]/95">
              ...
              <div className="flex flex-wrap gap-1"><span className="rounded-[2px] border border-gray-100 bg-gray-50 px-1.5 py-0.5 text-[0.55rem] font-bold text-gray-600 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 transition-all duration-300 hover:shadow-lg hover:border-[#D4AF37]/50">Commercial</span></div>
            </motion.div>

            <motion.div variants={floatGlow} initial="hidden" whileInView="animate" viewport={{ once: true }} className="absolute bottom-[15%] left-[0%] z-30 flex w-[180px] flex-col rounded-[8px] border border-[#D4AF37]/40 bg-gradient-to-b from-white to-[#D4AF37]/10 p-3 backdrop-blur-md dark:border-[#D4AF37]/40 dark:from-gray-800 dark:to-[#D4AF37]/15">
              <div className="absolute -top-2 left-1/2 flex -translate-x-1/2 items-center justify-center rounded-[4px] bg-gradient-to-r from-[#FEF08A] via-[#FBBF24] to-[#F59E0B] px-2 py-0.5 text-[0.5rem] font-black tracking-widest text-white shadow-md dark:bg-gradient-to-r from-[#FEF08A] via-[#FBBF24] to-[#F59E0B] dark:text-gray-900 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_8px_24px_rgba(251,191,36,0.25)] active:scale-95">NEW</div>
              <div className="mb-2 mt-2 flex items-center justify-between">
                ...
                <div className="flex h-6 w-6 items-center justify-center rounded-full bg-[#D4AF37]/20 text-[0.55rem] font-black text-[#D4AF37] ring-1 ring-[#D4AF37]/40 dark:bg-[#D4AF37]/20 dark:text-[#D4AF37] dark:ring-[#D4AF37]/40">88%</div>
              </div>
              <div className="flex flex-wrap gap-1"><span className="rounded-[2px] border border-[#D4AF37]/20 bg-white/50 px-1.5 py-0.5 text-[0.55rem] font-bold text-gray-700 dark:border-[#D4AF37]/20 dark:bg-gray-900/50 dark:text-gray-300">Multi-Unit</span></div>
            </motion.div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ type: "spring", stiffness: 250, damping: 25 }} className="flex flex-col items-center rounded-[8px] border border-gray-200/50 bg-gray-50 p-6 text-center shadow-md dark:border-gray-800/50 dark:bg-[#0a101d]">
            <div className="mb-8 flex flex-col items-center gap-4">
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-white shadow-sm ring-1 ring-gray-200/80 dark:bg-gray-900 dark:ring-gray-800">
                <Activity size={20} className="text-[#D4AF37] dark:text-[#D4AF37]" />
              </div>
            ...
            <div className="flex flex-col gap-6">
              {investorData.expectations.map((item, idx) => (
                <div key={idx} className="flex flex-col items-center gap-3 rounded-[4px] bg-white p-4 shadow-sm dark:bg-[#030712]/50 text-center border border-gray-100 dark:border-gray-800 transition-all duration-300 hover:shadow-lg hover:border-[#D4AF37]/50">
                  ...
                  <div className="flex flex-col items-center">
                    <div className="mb-2 flex items-center justify-center gap-2">
                      <item.icon size={16} className="text-[#D4AF37] dark:text-[#D4AF37]" strokeWidth={2.5} />
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ type: "spring", stiffness: 250, damping: 25, delay: 0.2 }} className="relative flex flex-col items-center justify-center overflow-hidden rounded-[8px] bg-gradient-to-b from-[#0f172a] to-[#030712] p-8 text-center shadow-xl ring-1 ring-white/10 dark:from-[#1e293b] dark:to-[#0a101d]">
            ...
            <div className="relative flex h-36 w-36 items-center justify-center">
              <motion.div variants={pulseRing} initial="animate" className="absolute h-full w-full rounded-full border-2 border-[#D4AF37]/50 dark:border-[#D4AF37]/50" />
              <motion.div variants={pulseRing} initial="animate" transition={{ delay: 1 }} className="absolute h-[75%] w-[75%] rounded-full border border-[#D4AF37]/70 dark:border-[#D4AF37]/70" />
              <motion.div variants={pulseRing} initial="animate" transition={{ delay: 2 }} className="absolute h-[50%] w-[50%] rounded-full border border-[#D4AF37]/90 dark:border-[#D4AF37]/90" />

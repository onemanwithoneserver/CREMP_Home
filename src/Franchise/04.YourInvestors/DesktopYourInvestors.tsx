        ...
        <div className="mb-24 flex flex-col items-center gap-16 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="relative flex h-[500px] w-full scale-[0.8] items-center justify-center sm:scale-90 lg:w-[50%] lg:scale-100">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-center rounded-full bg-[#D4AF37]/10 p-1 dark:bg-[#D4AF37]/10">
                      <pill.icon size={12} className="text-[#D4AF37] dark:text-[#D4AF37]" />
                    </div>
            ...
            <motion.div 
              ...
              className="relative z-30 flex h-28 w-28 flex-col items-center justify-center rounded-[2rem] border border-[#D4AF37]/30 bg-white/90 shadow-[0_0_50px_rgba(178,127,28,0.2)] backdrop-blur-md dark:border-[#D4AF37]/30 dark:bg-[#0a101d]/90 dark:shadow-[0_0_50px_rgba(246,178,59,0.15)]"
            >
              <YourBrandLogo size="lg" stacked={true} />
              <motion.div variants={pulseRing} initial="animate" className="absolute -inset-4 -z-10 rounded-[2.5rem] border border-[#D4AF37]/30 dark:border-[#D4AF37]/30" />
              <motion.div variants={pulseRing} initial="animate" transition={{ delay: 1 }} className="absolute -inset-8 -z-10 rounded-[3rem] border border-[#D4AF37]/15 dark:border-[#D4AF37]/15" />
            </motion.div>
            ...
            >
              ...
              <div className="flex flex-wrap gap-1.5">
                {['₹5Cr+ Budget', 'Tier 1 Cities', 'F&B Exp.'].map(l => (
                  <span key={l} className="rounded-[2px] border border-gray-100 bg-gray-50 px-2 py-0.5 text-[0.6rem] font-bold text-gray-600 transition-colors hover:bg-gray-200 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:hover:bg-gray-800 transition-all duration-300 hover:shadow-lg hover:border-[#D4AF37]/50">
                    {l}
                  </span>
                ))}
              </div>
            ...
            >
              ...
              <div className="flex flex-wrap gap-1.5">
                {['Multi-Unit', 'Master Fran.', 'Active'].map(l => (
                  <span key={l} className="rounded-[2px] border border-[#D4AF37]/20 bg-white/50 px-2 py-0.5 text-[0.6rem] font-bold text-gray-700 transition-colors hover:bg-[#D4AF37]/10 dark:border-[#D4AF37]/20 dark:bg-gray-900/50 dark:text-gray-300 dark:hover:bg-[#D4AF37]/10">
                    {l}
                  </span>
                ))}
              </div>
                  ...
                  <div className="flex flex-col pt-1">
                    <div className="mb-2 flex items-center gap-2">
                      <div className="flex items-center justify-center rounded-full bg-[#D4AF37]/10 p-1.5 transition-colors group-hover:bg-[#D4AF37]/20 dark:bg-[#D4AF37]/10 dark:group-hover:bg-[#D4AF37]/20">
                        <item.icon size={18} className="text-[#D4AF37] dark:text-[#D4AF37]" strokeWidth={2.5} />
                      </div>
                      <span className="text-lg font-bold text-gray-900 transition-colors group-hover:text-[#D4AF37] dark:text-white dark:group-hover:text-[#D4AF37]">{item.title}</span>
                    </div>

                  ...
                  <div className="flex flex-col pt-1">
                    <div className="mb-2 flex items-center gap-2">
                      <motion.div
                        ...
                        className="flex items-center justify-center rounded-full bg-[#D4AF37]/10 p-1.5 transition-colors group-hover:bg-[#D4AF37]/20 dark:bg-[#D4AF37]/10 dark:group-hover:bg-[#D4AF37]/20"
                      >
                        <item.icon
                          size={18}
                          className="text-[#D4AF37] dark:text-[#D4AF37]"

        ...
        >
          ...
          <div className="flex flex-1 flex-col pt-1">
            <div className="flex items-center justify-between gap-3">
              <h4
                className={`text-[0.95rem] font-bold font-sans leading-tight transition-colors duration-300 ${
                  isOpen
    ...
    <div className="relative w-full overflow-hidden rounded-[8px] bg-gray-50 py-4 transition-colors duration-700 dark:bg-[#030712] dark:shadow-none">
      ...
      <Container className="relative z-10 flex flex-col items-center px-4">
        ...
        >
          ...
          <motion.p
            variants={fadeInUp}
            className="text-[0.95rem] font-medium font-sans leading-relaxed text-gray-600 dark:text-gray-400"
          >
            {faqData.desc}
          </motion.p>
        </motion.div>
        ...
        <motion.div
          ...
          className="relative flex w-full flex-col items-center justify-between overflow-hidden rounded-[8px] bg-gradient-to-br from-[#0B1221] to-[#030712] p-8 shadow-2xl ring-1 ring-white/10 text-center"
        >
          ...
          <div className="relative z-10 flex w-full flex-col">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="group relative flex w-full items-center justify-center gap-3 overflow-hidden rounded-[4px] bg-gradient-to-r from-[#D4AF37] to-[#b38728] px-6 py-4 text-[1rem] font-bold font-sans text-gray-900 shadow-md dark:from-[#D4AF37] dark:to-[#f9d08b]"
            >

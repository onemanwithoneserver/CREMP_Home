...
export default function MobileFAQ() {
    ...
    const renderFaqCard = (faq: any, index: number) => {
        ...
        return (
            ...
            >
                ...
                >
                    <div
                        className={`mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-full border transition-colors duration-200 ${isOpen
    ...
    return (
        <div className="relative w-full overflow-hidden rounded-[8px] bg-gray-50 py-4 transition-colors duration-700 dark:bg-[#0a1128] dark:shadow-none">
            <motion.div
                variants={pulseGlow}
                animate="animate"

  ...
  const renderFaqCard = (faq: any) => {
    ...
    return (
      <motion.div
        ...
        viewport={{ once: false }}
        whileHover={{ y: -2 }}
        className={`group relative overflow-hidden rounded-[4px] border bg-white/30 px-5 py-4 shadow-[0_4px_16px_rgba(0,0,0,0.05)] backdrop-blur-md transition-all hover:bg-white/50 hover:shadow-lg dark:bg-black/20 ${
          isOpen
      ...
      >
        ...
        >
          <div
            className={`mt-0.5 flex h-10 w-10 shrink-0 items-center justify-center rounded-full border transition-colors duration-200 ${
              isOpen
          ...
          <div className="flex flex-1 flex-col pt-1">
            <div className="flex items-center justify-between gap-4">
              <h4
                className={`text-[1.05rem] font-semibold leading-tight transition-colors duration-300 ${
                  isOpen
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-xl bg-white/40 pt-4 py-4 shadow-[0_8px_32px_rgba(0,0,0,0.05)] backdrop-blur-xl border border-white/40 transition-colors duration-700 dark:bg-[#0b1b42]/60 dark:border-white/10 dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
      ...
      <Container className="relative z-10 flex flex-col items-center">
        ...
        >
          <motion.div className="mb-6 flex items-center gap-2 rounded-[2px] border border-[#D4AF37]/30 bg-[#D4AF37]/10 px-4 py-1.5 backdrop-blur-xl dark:border-[#D4AF37]/30 dark:bg-[#D4AF37]/10">
            <motion.div
              whileHover={{ scale: 1.15, rotate: [0, -10, 10, 0] }}
              transition={{ duration: 0.3 }}
              className="cursor-pointer"

    ...
    <div className="w-full bg-[#ffffff] pt-24 pb-24 relative overflow-hidden">
      <Container className="relative z-10 flex flex-col items-center">
        ...
        <motion.h2 
          ...
          className="text-[3.2rem] font-black text-[#2A3A69] leading-[1.1] tracking-tight mb-6 text-center"
        >
          {faqData.title}
        </motion.h2>
        ...
        <motion.p 
          ...
          className="text-[1.1rem] text-[#3A4566] font-medium leading-relaxed mb-16 text-center"
        >
          {faqData.desc}
        </motion.p>
               ...
               >
                  <div className="flex items-start gap-6 relative z-10">
                     <div className="w-12 h-12 rounded-full bg-[rgba(199, 154, 23, 0.05)] flex items-center justify-center shrink-0 border border-[rgba(199, 154, 23, 0.15)]">
                        <faq.icon size={22} className="text-[#2A3A69]" strokeWidth={1.5} />
                     </div>
                     <div className="flex flex-col flex-1 pt-1.5">
                        <div className="flex items-start justify-between w-full mb-3">
                           <h4 className="font-bold text-[#2A3A69] text-[1.1rem] leading-tight">
                             {faq.q}
                           </h4>
                           <ChevronDown 
                             size={20} 
                             className={`text-[#2A3A69] transition-transform duration-300 mt-0.5 shrink-0 ml-4 ${isOpen ? 'rotate-180' : 'rotate-0'}`} 
                           />
                        </div>
                        ...
                        <AnimatePresence>
                          {isOpen ? (
                             ...
                             >
                               <p className="text-[0.95rem] text-[#3A4566] font-medium leading-relaxed pb-2">
                                 {faq.a}
                               </p>
                             </motion.div>
                          ) : (
                             ...
                             <motion.p
                               initial={{ opacity: 1 }}
                               exit={{ opacity: 0 }}
                               className="text-[0.95rem] text-[#3A4566] font-medium leading-relaxed line-clamp-2"
                             >
                               {faq.a}
                             </motion.p>
                          )}
        ...
        <motion.div 
           ...
           className="w-[90%] bg-[rgba(199, 154, 23, 0.05)] border border-[rgba(199, 154, 23, 0.15)] rounded-[2rem] p-8 px-12 flex items-center justify-between shadow-sm relative overflow-hidden"
        >
           ...
           <div className="flex items-center gap-6 relative z-10">
              <div className="w-20 h-20 rounded-full bg-[#2A3A69] flex flex-col items-center justify-center shrink-0 text-white relative shadow-lg">
              ...
              <div className="flex flex-col">
                 <h3 className="text-2xl font-black text-[#2A3A69] leading-tight mb-2 whitespace-pre-line">
                   {faqData.banner.title}
                 </h3>
                 <p className="text-[#3A4566] font-medium text-[0.95rem]">
                   {faqData.banner.desc}
                 </p>
              </div>
           </div>
           ...
           <div className="flex items-center gap-4 relative z-10">
              ...
              <button className="bg-white hover:bg-gray-50 text-[#2A3A69] px-8 py-3.5 rounded-xl font-bold text-[0.95rem] shadow-sm border border-[#2A3A69] transition-colors flex items-center gap-2">
                 <faqData.banner.btn2.icon size={18} strokeWidth={2} className="text-[#6B7491]" />

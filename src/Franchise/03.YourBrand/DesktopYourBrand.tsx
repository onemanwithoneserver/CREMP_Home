      ...
      <Container className="relative z-10 mx-auto max-w-7xl px-4 xl:px-0">
        <div className="flex flex-col items-center gap-16 lg:flex-row lg:items-center lg:justify-between">
          ...
          >
            ...
            >
              Take full control of your franchise narrative. Showcase your
              brand's unique value, attract qualified investors, and scale your
                    ...
                    {playingVideoId === item.id ? (
                      ...
                      <>
                        ...
                        <div className="absolute inset-x-0 top-0 flex flex-col items-start p-5 pointer-events-none">
                          ...
                          <p
                            className={`mt-1 text-gray-200 ${item.active ? "text-sm font-medium" : "text-xs"}`}
                          >
                            {item.subtitle}
                          </p>
                        </div>

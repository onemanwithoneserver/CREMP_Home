      ...
      <Container className="relative z-10">
        <div className="flex flex-col items-center gap-6">
          ...
          >
            ...
            <motion.p
              variants={fadeInUp}
              className="mb-6 px-2 text-[0.95rem] font-medium font-sans leading-relaxed text-gray-600 dark:text-gray-400"
            >
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="group flex w-full max-w-[280px] items-center justify-center gap-2 rounded-[4px] bg-gradient-to-r from-[#D4AF37] to-[#b38728] px-7 py-3.5 text-sm font-bold font-sans text-white shadow-md dark:from-[#D4AF37] dark:to-[#f9d08b] dark:text-gray-900"
              >
                Explore Dashboard
                <ArrowRight
                  size={16}
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="flex w-full max-w-[280px] items-center justify-center gap-2 rounded-[4px] border border-gray-200 bg-white px-7 py-3.5 text-sm font-bold font-sans text-gray-900 shadow-sm dark:border-gray-800 dark:bg-gray-900 dark:text-white"
              >
                View Live Demo
              </motion.button>
            </motion.div>

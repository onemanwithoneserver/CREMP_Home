...
export default function MobileYourBrand() {
  return (
    <div className="w-full bg-[#ffffff] pt-12 pb-12 px-5 overflow-hidden relative">
      ...
      >
        <p className="text-[0.9rem] text-[#3A4566] font-medium">{brandData.desc[0]}</p>
        
        <div className="flex flex-col gap-1.5 my-2">
          <p className="text-[1rem] text-[#2A3A69] font-bold">{brandData.desc[1]}</p>
          <p className="text-[1rem] text-[#2A3A69] font-bold">{brandData.desc[2]}</p>
          <p className="text-[1rem] text-[#2A3A69] font-bold">{brandData.desc[3]}</p>
        </div>

        <p className="text-[0.9rem] text-[#3A4566] font-medium leading-relaxed">{brandData.desc[4]}</p>
      </motion.div>

      {/* Vertical Showcase Menu */}
      <motion.div 
         initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.3 }}
         className="bg-white rounded-xl shadow-md border border-[#E2E6EE] p-5 mb-10"
      >
         ...
         <div className="flex flex-col gap-4">
            {brandData.showcaseMenu.map((item, idx) => (
              <div key={idx} className="flex items-center gap-3">
                 <div className="w-8 h-8 rounded-full bg-[rgba(199, 154, 23, 0.05)] flex items-center justify-center shrink-0 border border-[rgba(199, 154, 23, 0.15)] text-[#6B7491]">
                   <item.icon size={14} strokeWidth={1.5} />
                 </div>
                 <span className="text-[0.8rem] font-bold text-[#3A4566]">
                   {item.text}
                 </span>
              </div>
            ))}
      ...
      >
         <div className="w-full bg-[#2A3A69] rounded-[2rem] p-3 shadow-xl relative border-b-[6px] border-r-[3px] border-[#000000]">
            <div className="w-full bg-white rounded-xl overflow-hidden flex flex-col">
               
               <div className="flex items-center justify-between px-4 py-3 border-b border-[#E2E6EE]">
                  <div className="flex items-center gap-1.5">
                     <Store className="text-[#d97706]" size={14} />
                     <span className="font-black text-[#2A3A69] text-[0.65rem] tracking-wide">YOUR BRAND</span>
                  </div>
                  <div className="flex items-center gap-3 text-[0.5rem] font-bold text-[#6B7491]">
                     <span className="text-[#2A3A69] border-b-2 border-[#d97706] pb-0.5">Overview</span>
                     <span>Videos</span>
                  </div>
               </div>
               ...
               <div className="grid grid-cols-2 gap-y-3 px-4 py-4 border-b border-[#E2E6EE]">
                  <div className="flex items-center gap-2">
                     <Store className="text-[#6B7491]" size={16} />
                     <div>
                        <div className="font-bold text-[#2A3A69] text-sm leading-tight">150+</div>
                        <div className="text-[0.55rem] text-[#6B7491]">Outlets</div>
                     </div>
                  </div>
                  <div className="flex items-center gap-2">
                     <MapPin className="text-[#6B7491]" size={16} />
                     <div>
                        <div className="font-bold text-[#2A3A69] text-sm leading-tight">45+</div>
                        <div className="text-[0.55rem] text-[#6B7491]">Cities</div>
                     </div>
                  </div>
                  <div className="flex items-center gap-2">
                     <Users className="text-[#6B7491]" size={16} />
                     <div>
                        <div className="font-bold text-[#2A3A69] text-sm leading-tight">10K+</div>
                        <div className="text-[0.55rem] text-[#6B7491]">Investors Engaged</div>
                     </div>
                  </div>
                  <div className="flex items-center gap-2">
                     <Star className="text-[#d97706]" size={16} />
                     <div>
                        <div className="font-bold text-[#2A3A69] text-sm leading-tight">4.8/5</div>
                        <div className="text-[0.55rem] text-[#6B7491]">Rating</div>
                     </div>
                  </div>
               </div>
               ...
               <div className="p-4 bg-[#ffffff]">
                  <div className="flex items-center justify-between mb-3">
                     <span className="font-bold text-[#2A3A69] text-[0.7rem]">Featured Videos</span>
                  </div>
                  <div className="grid grid-cols-2 gap-3">
                     <div className="flex flex-col gap-1.5">
                        ...
                        <span className="text-[0.6rem] font-bold text-[#2A3A69]">Founder Story</span>
                     </div>
                     <div className="flex flex-col gap-1.5">
                        <div className="w-full h-16 bg-[#2A3A69] rounded flex flex-col items-center justify-center text-white">
                        ...
                        <span className="text-[0.6rem] font-bold text-[#2A3A69]">Video Search {'>'}</span>
                     </div>
                  </div>
               </div>
      ...
      <motion.div 
         ...
         className="w-full bg-[rgba(199, 154, 23, 0.05)] rounded-2xl border border-[rgba(199, 154, 23, 0.15)] p-5 flex flex-col items-center text-center gap-4 shadow-sm relative overflow-hidden"
      >
         ...
         <div className="w-14 h-14 rounded-full bg-[#2A3A69] flex items-center justify-center z-10 shadow-md">
         ...
         <div className="flex flex-col z-10">
            ...
            <h3 className="text-xl font-black text-[#2A3A69] leading-tight">

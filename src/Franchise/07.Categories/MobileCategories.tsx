      ...
      <div className="flex flex-col items-center text-center relative z-10">
        ...
        <div className="w-full grid grid-cols-3 gap-3 mb-12">
           {categoriesData.categories.map((category, idx) => (
             <motion.div 
               ...
               className="bg-white rounded-2xl p-4 flex flex-col items-center justify-center text-center shadow-sm border border-[#e5e7eb] h-32"
             >
                <div className="w-10 h-10 rounded-full bg-[#fdf8f0] flex items-center justify-center text-[#0a1128] mb-3 relative">
                   <category.icon size={18} strokeWidth={1.5} className="relative z-10" />
                </div>
                <span className="text-[0.6rem] font-bold text-[#0a1128] whitespace-pre-line leading-tight">
                  {category.label}
                </span>
        ...
        >
           <div className="flex items-center gap-2 mb-1">
              <div className="w-12 h-[1px] bg-gradient-to-r from-transparent to-[#e5e7eb]" />
              <Star size={12} className="text-[#d97706] fill-[#d97706]" />
              <div className="w-12 h-[1px] bg-gradient-to-l from-transparent to-[#e5e7eb]" />
           </div>

           <button className="w-full max-w-[280px] bg-[#0a1128] text-white px-6 py-4 rounded-xl font-bold text-[1rem] shadow-lg flex items-center justify-center gap-3">

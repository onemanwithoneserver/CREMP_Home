      ...
      <Container className="relative z-10 flex flex-col items-center px-4">
        ...
        >
          {categoriesData.categories.map((category, idx) => (
            <motion.div
              ...
              className="group relative flex h-36 cursor-pointer flex-col items-center justify-center overflow-hidden rounded-[8px] border border-gray-200/60 bg-gray-50/50 p-4 text-center shadow-sm dark:border-gray-800/60 dark:bg-[#0a101d]/50"
            >
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="group flex w-full items-center justify-center gap-3 rounded-[4px] bg-gray-900 px-6 py-3.5 text-[0.95rem] font-bold font-sans text-white shadow-md dark:bg-white dark:text-gray-900"
          >

  ...
  return (
    <div className="relative w-full overflow-hidden rounded-[8px] bg-white py-8 shadow-2xl transition-colors duration-700 dark:bg-[#030712] dark:shadow-none">
      ...
      <Container className="relative z-10 flex flex-col items-center">
        ...
        >
          <motion.div variants={fadeInUp} className="mb-6 flex items-center gap-2 rounded-[2px] border border-[#D4AF37]/20 bg-[#D4AF37]/5 px-4 py-1.5 backdrop-blur-md dark:border-[#D4AF37]/20 dark:bg-[#D4AF37]/5">
        ...
        >
          ...
          >
            <Users size={20} className="text-[#D4AF37] transition-transform group-hover:scale-110 dark:text-[#D4AF37]" />
          ...
          <div className="flex items-center gap-2 rounded-[2px] border border-gray-100 bg-gray-50 px-4 py-2 transition-colors hover:bg-gray-100 dark:border-gray-800/60 dark:bg-gray-900/50 dark:hover:bg-gray-800/60 transition-all duration-300 hover:shadow-lg hover:border-[#D4AF37]/50">
            <ShieldCheck size={16} className="text-[#D4AF37] dark:text-[#D4AF37]" />

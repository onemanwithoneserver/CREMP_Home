              ...
              {ecosystemData.issues.map((issue, idx) => (
                <div key={idx} className="flex items-center gap-3">
                  <motion.div
                    ...
                    className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-white/50 bg-white/50 text-[#D4AF37] shadow-[0_4px_12px_rgba(0,0,0,0.05)] backdrop-blur-md dark:border-white/10 dark:bg-black/40 dark:text-[#D4AF37] cursor-pointer"
                  >
                    <issue.icon size={14} />
                  </motion.div>
            ...
            >
              <div className="relative z-10 grid w-full grid-cols-2 gap-3 px-2">
                ...
                {ecosystemData.flowItems.map((item, idx) => (
                  ...
                  >
                    <motion.div
                      ...
                      className="mb-2 flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-white/60 shadow-inner backdrop-blur-sm border border-white/50 dark:bg-black/50 dark:border-white/10 cursor-pointer pointer-events-auto"
                    >
                      <item.icon
                        size={16}
                ...
                <motion.div
                  ...
                  className="absolute left-1/2 top-1/2 z-30 flex h-7 w-7 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-gradient-to-br from-[#D4AF37] to-[#b38728] text-white shadow-md ring-2 ring-gray-50 backdrop-blur-sm dark:from-[#D4AF37] dark:to-[#b38728] dark:ring-[#0a1128] cursor-pointer pointer-events-auto"
                >

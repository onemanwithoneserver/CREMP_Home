        ...
        <div className="relative flex w-full flex-col overflow-hidden border-y border-gray-200/80 bg-white shadow-2xl dark:border-gray-800/80 dark:bg-[#121c33]">
          <div className="relative flex w-full flex-col items-center p-6 pt-6 text-center">
            ...
            >
              ...
              <motion.h2
                variants={fadeInUp}
                className="mb-4 whitespace-pre-line text-[2.5rem] font-black font-sans leading-[1.1] tracking-tight text-gray-900 dark:text-white sm:text-[3rem]"
              >
                {foundingData.title}
              </motion.h2>
              ...
              <motion.p
                variants={fadeInUp}
                className="max-w-[320px] text-[0.95rem] font-medium font-sans leading-relaxed text-gray-600 dark:text-gray-400"
              >
                {foundingData.desc}
              </motion.p>
            </motion.div>
          ...
          <div className="relative z-10 flex w-full flex-col bg-gray-50/50 p-6 shadow-inner dark:bg-[#0a1128]/50">
            ...
            <div className="mb-8 flex flex-col gap-3">
              {foundingData.benefits.map((benefit, idx) => (
                <div
                  key={idx}
                  className="flex w-full items-center gap-3 rounded-[4px] border border-gray-200/50 bg-white/80 p-3 shadow-sm dark:border-gray-800/50 dark:bg-[#121c33]/60"
                >
              ...
              >
                <div className="relative z-10 flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[0.95rem] font-black font-sans text-white dark:text-gray-900">
                      {foundingData.buttons[0].title}
                    </span>
                    <span className="text-[0.65rem] font-bold font-sans text-white/90 dark:text-gray-900/80">

        ...
        <div className="relative flex w-full flex-col overflow-hidden rounded-[8px] border border-gray-200/80 bg-white shadow-2xl dark:border-gray-800/80 dark:bg-[#121c33] lg:flex-row lg:items-stretch lg:p-4">
          ...
          <div className="relative flex w-full flex-col p-8 pt-10 lg:w-[48%] lg:px-10 lg:py-12">
            ...
            <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={{ show: { transition: { staggerChildren: 0.15 } } }}>
              <motion.div variants={fadeInUp} className="mb-6 flex w-fit items-center gap-2 rounded-[2px] border border-[#D4AF37]/20 bg-[#D4AF37]/5 px-4 py-1.5 backdrop-blur-md dark:border-[#D4AF37]/30 dark:bg-[#D4AF37]/10">
            ...
            >
              ...
              {foundingData.rocketNodes.map((node, idx) => {
                ...
                return (
                  ...
                  >
                    <div className="group relative flex h-12 w-12 cursor-pointer items-center justify-center rounded-full border border-[#D4AF37]/30 bg-white/90 text-[#D4AF37] shadow-[0_10px_20px_rgba(178,127,28,0.15)] backdrop-blur-md transition-all hover:scale-110 hover:bg-white hover:shadow-[0_10px_25px_rgba(178,127,28,0.25)] dark:border-[#D4AF37]/30 dark:bg-[#111827]/90 dark:text-[#D4AF37] dark:hover:bg-[#1e293b] dark:hover:shadow-[0_10px_25px_rgba(246,178,59,0.25)]">
          ...
          <div className="relative z-10 flex w-full flex-col rounded-[8px] bg-gray-50/50 p-8 shadow-[inset_1px_0_0_rgba(0,0,0,0.05)] dark:bg-[#0a1128]/50 dark:shadow-[inset_1px_0_0_rgba(255,255,255,0.05)] lg:w-[52%] lg:p-12">
            ...
            <div className="mb-8 flex items-center gap-4 border-b border-gray-200/60 pb-6 dark:border-gray-800/60">
              ...
              >
                <Gem size={20} className="text-[#D4AF37] dark:text-[#D4AF37]" strokeWidth={2} />
              </motion.div>
              ...
              {foundingData.benefits.map((benefit, idx) => (
                ...
                >
                  <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#D4AF37]/10 transition-colors group-hover:bg-[#D4AF37]/20 dark:bg-[#D4AF37]/10 dark:group-hover:bg-[#D4AF37]/20">
                    <Check size={14} className="text-[#D4AF37] dark:text-[#D4AF37]" strokeWidth={3} />
                  </div>
            ...
            <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-stretch">
              ...
              {/* <motion.button 
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="group flex items-center justify-center gap-3 rounded-[4px] border border-gray-200 bg-white px-6 py-4 shadow-sm transition-all hover:border-[#D4AF37]/50 hover:bg-gray-50 hover:shadow-md dark:border-gray-700/80 dark:bg-[#111827] dark:hover:border-[#D4AF37]/50 dark:hover:bg-gray-800 sm:w-[35%]"
              >
                <Btn2Icon size={20} className="text-[#D4AF37] transition-transform group-hover:scale-110 dark:text-[#D4AF37]" strokeWidth={1.5} />

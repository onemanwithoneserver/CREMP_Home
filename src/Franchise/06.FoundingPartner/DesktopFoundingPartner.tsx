...
export default function DesktopFoundingPartner() {
  ...
  return (
    <div className="w-full bg-[#fdfdfd] pt-20 pb-20 relative overflow-hidden">
      <Container className="relative z-10">
        
        {/* Main Dark Card Container */}
        <div className="w-full bg-[#0a1128] rounded-[2.5rem] p-12 pr-12 flex items-stretch gap-10 shadow-2xl relative overflow-hidden border border-[#1e293b]">
           ...
           <div className="w-[45%] flex flex-col relative z-10 pl-4 pt-6">
              ...
              <motion.p 
                ...
                className="text-[1rem] text-[#9ca3af] font-medium leading-relaxed max-w-sm mb-16"
              >
                {foundingData.desc}
              </motion.p>
              ...
              >
                 ...
                 <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[300px] h-[80px]">
                    {/* Ring 1 (Bottom) */}
                    <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full h-12 rounded-[100%] border border-[#d97706]/30 bg-[#0a1128] shadow-[0_0_30px_rgba(217,119,6,0.15)] flex items-end justify-center pb-1">
                       <span className="text-[0.65rem] font-black tracking-[0.2em] text-[#d97706]">FOUNDING PARTNER</span>
                    </div>
                    {/* Ring 2 (Middle) */}
                    <div className="absolute bottom-4 left-1/2 -translate-x-1/2 w-[270px] h-10 rounded-[100%] border-t border-[#d97706]/50 bg-[#111827] flex items-center justify-center">
                    </div>
                    {/* Ring 3 (Top) */}
                    <div className="absolute bottom-8 left-1/2 -translate-x-1/2 w-[230px] h-8 rounded-[100%] bg-gradient-to-t from-[#111827] to-[#1f2937] shadow-[inset_0_2px_4px_rgba(255,255,255,0.1)] flex items-center justify-center border border-[#374151]" />
                 ...
                 <div className="absolute bottom-16 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center">
                    ...
                    <div className="w-16 h-40 bg-gradient-to-tr from-[#b45309] via-[#f59e0b] to-[#fde68a] rounded-t-[100%] rounded-b-xl shadow-2xl relative overflow-hidden">
                       ...
                       {/* Window */}
                       <div className="absolute top-12 left-1/2 -translate-x-1/2 w-8 h-8 rounded-full bg-[#0a1128] border-[3px] border-[#fbbf24] shadow-inner" />
                    </div>
                   ...
                   return (
                     <div key={idx} className={`absolute z-30 flex flex-col items-center gap-2 ${
                       ...
                       isTop ? 'top-[40px]' : 'top-[160px]'
                        ...
                        <div className="w-12 h-12 rounded-full border border-[#d97706]/40 bg-[#0a1128]/80 backdrop-blur-md flex items-center justify-center text-[#d97706] relative shadow-[0_0_15px_rgba(217,119,6,0.2)]">
                        ...
                        <span className="text-[0.6rem] text-[#9ca3af] font-bold text-center whitespace-pre-line leading-tight">
                          {node.label}
                        </span>
                     </div>
                   )
           ...
           <motion.div 
             ...
             className="w-[55%] bg-[#0a1128] rounded-[2rem] border border-[#d97706]/40 p-8 shadow-[0_0_30px_rgba(217,119,6,0.05)] flex flex-col relative z-10 h-full"
           >
              {/* Header */}
              ...
              <div className="flex flex-col gap-4 flex-1 mb-8">
                 {foundingData.benefits.map((benefit, idx) => (
                   <div key={idx} className="w-full bg-[#0f172a]/50 rounded-xl border border-[#1e293b] p-4 px-5 flex items-center gap-5 group hover:border-[#d97706]/30 transition-colors">
                      <div className="w-6 h-6 rounded-full bg-[#d97706] flex items-center justify-center shrink-0">
                         <Check size={14} className="text-[#0a1128]" strokeWidth={3} />
                      </div>
                      <div className="w-10 h-10 rounded-full border border-[#334155] flex items-center justify-center shrink-0 text-[#9ca3af] group-hover:text-[#d97706] transition-colors">
              ...
              <div className="flex items-stretch gap-4 mb-5">
                 <button className="flex-1 bg-gradient-to-r from-[#fbbf24] to-[#d97706] hover:from-[#f59e0b] hover:to-[#b45309] rounded-xl p-4 flex items-center gap-4 transition-all shadow-lg transform hover:scale-[1.02]">
                    <div className="w-10 h-10 flex items-center justify-center">
                       <Btn1Icon size={28} className="text-[#0a1128]" strokeWidth={2} />
                    </div>
                    <div className="flex flex-col text-left">
                       <span className="text-[#0a1128] font-black text-lg">{foundingData.buttons[0].title}</span>
                       <span className="text-[#0a1128]/80 font-bold text-[0.65rem]">{foundingData.buttons[0].subtitle}</span>
                    </div>
                 </button>
              ...
              <div className="flex items-center justify-center gap-2 mt-auto">
                 ...
                 <span className="text-[0.7rem] text-[#9ca3af]">{foundingData.bottomDisclaimer}</span>
              </div>
           </motion.div>

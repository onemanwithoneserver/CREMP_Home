    ...
    <div className="relative w-full overflow-hidden bg-gray-50 py-24 transition-colors duration-700 dark:bg-[#030712]">
      ...
      <Container className="relative z-10 max-w-7xl px-4 xl:px-0">
        ...
        <motion.div variants={staggerContainer} initial="hidden" whileInView="show" viewport={{ once: true, margin: "-100px" }} className="grid grid-cols-12 grid-rows-2 gap-6 h-[500px]">
          ...
          <motion.div variants={scaleIn} className="col-span-5 row-span-2 rounded-[8px] border border-gray-200 bg-white p-10 shadow-sm dark:border-gray-800 dark:bg-[#0a101d] flex flex-col justify-between overflow-hidden relative group">
            ...
            <div className="relative z-10 mt-8 pt-8 border-t border-gray-100 dark:border-gray-800">
              <p className="text-[1.1rem] font-bold text-gray-900 dark:text-white">
                CREMP brings <span className="text-[#D4AF37] dark:text-[#D4AF37]">{whyInvestData.conclusion}</span>
              </p>
            </div>
          </motion.div>
              ...
              {whyInvestData.flowItems.map((item, idx) => (
                <div key={idx} className="flex flex-col items-center group/item cursor-pointer">
                  <div className="flex h-16 w-16 items-center justify-center rounded-[8px] border border-gray-100 bg-gray-50 shadow-sm transition-all hover:-translate-y-2 hover:shadow-md dark:border-gray-800 dark:bg-[#0a1128] transition-all duration-300 hover:shadow-lg hover:border-[#D4AF37]/50">
                    <item.icon size={24} className="text-gray-400 transition-colors group-hover/item:text-[#D4AF37] dark:text-gray-500 dark:group-hover/item:text-[#D4AF37]" />
                  </div>
          ...
          <motion.div variants={scaleIn} className="col-span-7 row-span-1 rounded-[8px] bg-gradient-to-br from-[#D4AF37] to-[#b38728] p-10 shadow-xl dark:from-[#0a101d] dark:to-[#0a1128] dark:border dark:border-gray-800 flex items-center justify-between group overflow-hidden relative">
            ...
            <div className="relative z-10 flex h-32 w-32 items-center justify-center rounded-full border border-white/20 bg-white/10 backdrop-blur-md">
              <div className="absolute h-full w-full rounded-full border-t-2 border-[#D4AF37] animate-spin" style={{ animationDuration: '3s' }} />

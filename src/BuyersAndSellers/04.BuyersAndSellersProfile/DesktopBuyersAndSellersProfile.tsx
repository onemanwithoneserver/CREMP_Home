...
export default function DesktopBuyersAndSellersProfile() {
        ...
        <div className="flex gap-12 rounded-[8px] bg-white p-8 shadow-xl dark:bg-[#0a101d] dark:border dark:border-gray-800">
          ...
          <div className="flex w-2/3 flex-col py-2 pl-4">
            <div className="mb-8 flex items-center gap-3">
              ...
              <h3 className="text-xl font-black text-gray-900 dark:text-white">{BuyersAndSellersProfileData.expectationsTitle}</h3>
            </div>

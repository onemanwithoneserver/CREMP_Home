  ...
  steps: [
    {
      ...
      desc: "Register as a buyer or seller with your basic real estate requirements.",
      color: "teal",
    },
    {
      ...
      desc: "Define your budget, target locations, property type, and timeline.",
      color: "blue",
    },
    {
      icon: Search,
      ...
      desc: "Browse integrated listings from Zillow, LoopNet, Realtor.com, and more.",
      color: "teal",
    },
    {
      icon: MessageSquare,
      ...
      desc: "Directly message brokers, schedule property tours, and access full reports.",
      color: "blue",
    },
    {
      icon: Handshake,
      ...
      desc: "Finalize your purchase or sale and secure your new property.",
      color: "teal",
    },
  ],

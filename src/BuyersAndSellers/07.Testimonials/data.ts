...
export const testimonialsData = {
  ...
  buttons: [
    { icon: Rocket, title: 'Join CREMP Now', subtitle: 'Secure your early access spot. Start exploring properties.' },
    { icon: CalendarDays, title: 'Schedule\nOnboarding' }
  ],
  bottomDisclaimer: 'Limited early access spots available for buyers and sellers.'
};

...
import { User, Mail,Lock,Eye,EyeOff,Globe,ChevronDown,ArrowRight,CheckCircle2,Loader2,Check,Briefcase,Store,TrendingUp,Users,Building } from "lucide-react";
              ...
              {isSuccess ? (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-[75%] py-3 bg-gradient-to-r from-[#bf953f] via-[#d4af37] to-[#b38728] text-white rounded-[4px] font-semibold text-[13px] shadow-lg hover:-translate-y-0.5 transition-transform"
                  >
                    Go to Login
                  </button>
                </motion.div>

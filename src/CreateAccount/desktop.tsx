        ...
        >
          ...
          <div className="px-7 pt-7 pb-5 xl:px-9 xl:pt-8 xl:pb-6">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-3 py-2.5 bg-white dark:bg-[#121c33] border border-gray-200 dark:border-white/10 rounded-[8px] text-[12px] text-[#0a1128] dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#d4af37]/50 focus:border-[#d4af37]/50 transition-all shadow-sm font-medium"
                    />
                  </div>
                </div>
                <div className="space-y-1.5">
              ...
              >
                ...
                <div className="relative group flex">
                  ...
                  <input
                    ...
                    className="flex-1 pl-4 pr-4 py-2.5 bg-white dark:bg-[#121c33] border border-gray-200 dark:border-white/10 rounded-r-[8px] text-[12px] text-[#0a1128] dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#d4af37]/50 focus:border-[#d4af37]/50 transition-all shadow-sm font-medium"
                  />
                </div>
              </motion.div>
              <motion.div
              ...
              >
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-10 py-2.5 bg-white dark:bg-[#121c33] border border-gray-200 dark:border-white/10 rounded-[8px] text-[12px] text-[#0a1128] dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#d4af37]/50 focus:border-[#d4af37]/50 transition-all shadow-sm font-medium"
                  />
                  <button
                    type="button"
            ...
            <motion.p
              ...
              className="text-center mt-5 text-[12px] font-medium text-gray-500 dark:text-gray-400"
            >

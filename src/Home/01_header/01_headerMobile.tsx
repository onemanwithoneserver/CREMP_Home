...
export default function Mobile() {
  ...
  return (
    <motion.header 
      ...
      className="w-full flex items-center justify-between px-4 py-4 bg-transparent absolute top-0 z-50 text-[#050C17] dark:text-white"
    >
      <div className="flex items-center gap-2">
        ...
        <div className="flex flex-col justify-center">
          <span className="text-lg font-bold tracking-tight text-[#050C17] dark:text-white leading-none">CREMP</span>
          <span className="text-gray-600 dark:text-gray-400 text-[8px] tracking-widest uppercase mt-0.5 leading-none">An Integrated CRE Marketplace</span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <button className="text-[#050C17] dark:text-white p-2">

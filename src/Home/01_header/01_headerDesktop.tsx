...
export default function Desktop() {
  ...
  return (
    <motion.header
      ...
      className={`fixed z-50 flex w-full items-center justify-center px-6 py-3.5 text-[#0a1128] transition-all duration-500 dark:text-white lg:px-12 ${
        scrolled
      ...
      <div className="relative flex w-full max-w-7xl items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <motion.button
            ...
            className={`flex h-10 w-10 items-center justify-center rounded-[4px] border transition-all duration-300 ${
              theme === "dark"

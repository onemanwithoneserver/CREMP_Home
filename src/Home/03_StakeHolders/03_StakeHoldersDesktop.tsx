...
export default function Desktop() {
  ...
  const illustrationUrl = "https://images.unsplash.com/photo-1614850523459-c2f4c699c52e?auto=format&fit=crop&w=800&q=80";
          ...
          <div className="absolute -left-[45vh] top-1/2 h-[90vh] w-[90vh] -translate-y-1/2 rounded-full border border-dashed border-gray-300 shadow-[0_0_60px_rgba(178,127,28,0.05)] dark:border-gray-800/60 dark:shadow-[0_0_60px_rgba(246,178,59,0.02)]">
            ...
            {stakeholdersData.map((stakeholder, idx) => {
              ...
              return (
                ...
                >
                  <motion.div animate={{ rotate: -angle }} className="group relative flex items-center">
                    {isActive && (
                      <motion.div
                    ...
                    <div
                      className={`absolute left-[calc(100%+16px)] w-32 text-left text-xs font-bold tracking-wide transition-all duration-400 xl:w-40 xl:text-sm ${
                        isActive

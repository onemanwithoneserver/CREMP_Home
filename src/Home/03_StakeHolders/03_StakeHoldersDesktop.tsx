...
export default function Desktop() {
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-hidden bg-[#050C17] px-6 pb-12 pt-20 font-sans text-white lg:px-12">
      ...
      <div className="mx-auto mb-10 flex max-w-3xl flex-col items-center text-center">
        <motion.div 
          ...
          className="mb-4 flex w-fit items-center gap-2 rounded-full border border-[#F6B23B]/30 bg-[#F6B23B]/10 px-4 py-1.5 text-[#F6B23B] shadow-[0_0_15px_rgba(246,178,59,0.15)] backdrop-blur-[2px]"
        >
        ...
        >
          One Platform. <span className="bg-gradient-to-r from-[#F6B23B] to-[#ffc15e] bg-clip-text text-transparent drop-shadow-[0_4px_4px_rgba(0,0,0,0.5)]">Unlimited Opportunities.</span>
        </motion.h2>
      ...
      <div className="mx-auto mb-10 grid w-full max-w-[1300px] grid-cols-1 items-center gap-8 lg:grid-cols-[500px_1fr]">
        ...
        <div className="group/orbit relative mx-auto flex h-[500px] w-[500px] items-center justify-center lg:mx-0">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="absolute inset-[45px] rounded-full border border-gray-700/30"
          />
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="absolute inset-[90px] rounded-full border border-[#111A2C]"
          >
          ...
          >
            ...
            <span className="text-2xl font-bold tracking-tight text-white">CREMP</span>
            <span className="mt-1 text-center text-[10px] leading-tight tracking-wider text-gray-400">
          ...
          {stakeholdersData.map((stakeholder, index) => {
            ...
            return (
              ...
              >
                <div className="relative">
                  ...
                  <motion.div 
                    className={`relative z-10 flex h-16 w-16 items-center justify-center rounded-full border bg-[#0C1525] transition-all duration-500 ${
                      isActive 
                        ? 'scale-110 border-[#F6B23B] text-[#F6B23B] shadow-[0_0_30px_rgba(246,178,59,0.5)]' 
                        : 'border-gray-700 text-gray-400 hover:border-[#F6B23B]/50 hover:text-white'
                    }`}
                ...
                <span className={`mt-3 text-center text-sm font-bold transition-all duration-500 ${isActive ? 'text-white drop-shadow-[0_0_5px_rgba(255,255,255,0.5)]' : 'text-gray-500'}`} style={{ whiteSpace: 'pre-line' }}>
                  {stakeholder.label}
                </span>
              </motion.div>
            );
        ...
        <div className="flex h-full flex-col">
          <div className="flex overflow-hidden rounded-t-[8px] border border-gray-800 bg-[#0C1525]/80 p-1.5 backdrop-blur-[8px]">
              ...
              return (
                <button
                  ...
                  className={`relative flex flex-1 flex-col items-center justify-center rounded-[4px] px-2 py-3 transition-all duration-300 ${
                    isActive ? 'text-[#F6B23B]' : 'text-gray-400 hover:bg-[#111A2C]/50 hover:text-gray-200'
                  }`}
                >
                  {isActive && (
                    <motion.div 
                      layoutId="activeTabOutline"
                      className="absolute inset-0 rounded-[4px] border border-[#F6B23B]/50 bg-[#111A2C] shadow-[inset_0_0_15px_rgba(246,178,59,0.1)]"
          ...
          <div className="relative flex flex-1 flex-col overflow-hidden rounded-b-[8px] border-x border-b border-gray-800 bg-[#08101E]/95 p-6 backdrop-blur-[8px]">
            <AnimatePresence mode="wait">
              {stakeholdersData.map((stakeholder) => {
                ...
                return (
                  ...
                  >
                    <h3 className="mb-8 text-3xl font-bold text-white">{stakeholder.title}</h3>
                    ...
                    <div className="mt-auto border-t border-gray-800/50 pt-6">
                      <button className="group flex w-fit items-center gap-2 rounded-[4px] border border-[#F6B23B]/50 bg-transparent px-6 py-2.5 text-sm font-bold text-[#F6B23B] transition-all hover:bg-[#F6B23B]/10 active:scale-95">
                        Explore More
      ...
      <motion.div 
        ...
        className="mx-auto flex w-full max-w-7xl flex-col items-center justify-between gap-6 rounded-[8px] border border-gray-800 bg-gradient-to-br from-[#0C1525] to-[#050C17] p-5 shadow-[0_8px_30px_rgba(0,0,0,0.5)] md:flex-row md:gap-8 lg:p-6"
      >
        <div className="flex w-full items-center gap-4 border-b border-gray-800 pb-5 md:w-auto md:border-b-0 md:border-r md:pb-0 md:pr-8">
          <div className="group relative flex h-12 w-12 flex-shrink-0 items-center justify-center overflow-hidden rounded-full border border-gray-700 bg-[#111A2C]">
            <div className="absolute inset-0 bg-[#F6B23B]/20 opacity-0 blur-xl transition-opacity duration-500 group-hover:opacity-100" />
            <ShieldCheck className="relative z-10 h-6 w-6 text-[#F6B23B]" strokeWidth={1.8} />
          </div>
          <div className="flex flex-col">
            <h4 className="text-base font-bold text-white">Trusted. Secure. Seamless.</h4>
            <p className="mt-0.5 text-[11px] text-gray-400">Your data and transactions are protected<br/>with enterprise-grade security.</p>
          </div>
        </div>

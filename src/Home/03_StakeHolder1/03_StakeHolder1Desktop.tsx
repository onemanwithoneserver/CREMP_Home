              ...
              <div className="p-6 lg:p-10 flex-1 flex flex-col justify-center relative z-10 w-full lg:w-1/2">
                <div className="flex flex-col items-start gap-3 mb-4">
                  <motion.div
                    ...
                    className={`w-12 h-12 shrink-0 rounded-[4px] flex items-center justify-center transition-colors duration-300 ${theme.iconWrapper}`}
                  >
                    <card.icon size={22} strokeWidth={1.5} />
                  </motion.div>
                  <div>
                    <h3
                      className={`text-2xl font-bold leading-tight transition-colors duration-300 ${theme.titleText} ${theme.titleHover}`}
                    >
                      {card.title}
                    </h3>
                    <p
                      className={`${theme.subtitle} font-bold uppercase tracking-widest text-[11px] mt-1`}
                    >
                ...
                >
                  {card.features.map((feature, fIdx) => (
                    <motion.div
                      variants={fadeUpItem}
                      key={fIdx}
                      className="flex flex-col items-center text-center gap-2 group/feature"
                    >
                      <motion.div
                        initial={{ scale: 1, rotate: 0 }}
                        animate={{ scale: 1, rotate: 0 }}
                        whileHover={{ scale: 1.15, rotate: [0, -10, 10, 0] }}
                        transition={{ duration: 0.3 }}
                        className={`w-10 h-10 flex items-center justify-center rounded-[4px] border transition-colors duration-300 ${theme.featureBg}`}
                      >
                        <feature.icon
                          size={18}
                          strokeWidth={1.5}
                          className={theme.featureIcon}
                        />
                      </motion.div>
                      <span
                        className={`text-[12px] font-semibold leading-snug transition-colors duration-300 ${theme.featureText}`}
                      >
              ...
              >
                <div className="w-full h-full relative z-10">
                  <img
                    src={card.image}
                    alt={card.title}
                    className="w-full h-full object-cover mix-blend-overlay opacity-90 transition-opacity duration-300"
                  />
            ...
            return (
              ...
              >
                <div className="p-6 lg:p-10 flex-1 flex flex-col justify-center relative z-10 w-full lg:w-1/2">
                  <div className="flex flex-col items-start gap-3 mb-4">
                    <div
                      className={`w-12 h-12 shrink-0 rounded-[6px] flex items-center justify-center transition-colors duration-300 ${theme.iconWrapper}`}
                    >
                      <card.icon size={22} strokeWidth={1.5} />
                    </div>
                    <div>
                  ...
                  >
                    {card.features.map((feature, fIdx) => (
                      ...
                      >
                        <div
                          className={`w-10 h-10 flex items-center justify-center rounded-[6px] transition-colors duration-300 ${theme.featureBg}`}
                        >
                          <feature.icon
                            size={18}
                            strokeWidth={1.5}
        ...
        <div className="p-6 lg:p-10 flex-1 flex flex-col justify-center gap-5 z-10 w-full lg:w-3/5 bg-slate-50 dark:bg-slate-900">
            ...
            {block3.categories.map((category, idx) => (
              ...
              >
                <motion.div
                  ...
                  whileHover={{ scale: 1.15, rotate: [0, -10, 10, 0] }}
                  transition={{ duration: 0.3 }}
                  className="w-10 h-10 rounded-[4px] bg-emerald-50 dark:bg-slate-700 text-emerald-600 dark:text-emerald-400 flex items-center justify-center group-hover:bg-emerald-500 group-hover:text-white transition-colors duration-200"
                >
          ...
          <div className="mt-2 w-full">
            ...
            >
              ...
              <ArrowUpRight
                size={16}
                className="relative z-10 transition-transform duration-300 group-hover/btn3:translate-x-1 group-hover/btn3:-translate-y-1"
              />
            </motion.button>
          </div>
        </div>
            ...
            {block3.floaters.map((floater, idx) => (
              ...
              >
                <motion.div
                  ...
                  whileHover={{ scale: 1.15, rotate: [0, -10, 10, 0] }}
                  transition={{ duration: 0.3 }}
                  className="w-8 h-8 rounded-[4px] bg-emerald-50 dark:bg-slate-700 text-emerald-600 dark:text-emerald-400 flex items-center justify-center shadow-sm transition-colors duration-200"
                >

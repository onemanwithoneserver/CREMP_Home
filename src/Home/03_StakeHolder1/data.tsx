import { 
  Building2, Store, Users, PlayCircle, Globe, Megaphone, 
  Search, Handshake, Lightbulb, User, Building, BarChart, 
  Award, FileText, Briefcase, ShoppingBag, PlaySquare, 
  ShieldCheck, Scale, Target
} from "lucide-react";
...
export const stakeholderData = {
  block1: {
    ...
    floaters: [
      { icon: Award, label: <>Build<br/>Credibility</> },
      { icon: Users, label: <>Generate<br/>Quality Leads</> },
      { icon: BarChart, label: <>Expand<br/>Your Reach</> },
      { icon: Target, label: <>Drive More<br/>Opportunities</> },
    ],
    cards: [
      {
        id: "developers",
        ...
        features: [
          { icon: Megaphone, labelDesktop: <>Brand<br/>Building</>, labelMobile: "Brand Building" },
          { icon: PlayCircle, labelDesktop: <>Video<br/>Showcase</>, labelMobile: "Video Showcase" },
      ...
      },
      {
        ...
        description: "Showcase your franchise opportunities, educate potential partners through engaging videos and content, and seamlessly expand into new markets.",
        features: [
          { icon: Megaphone, labelDesktop: <>Brand<br/>Awareness</>, labelMobile: "Brand Awareness" },
          { icon: PlayCircle, labelDesktop: <>Video<br/>Explainers</>, labelMobile: "Video Explainers" },
  ...
  block2: {
    ...
    subtitle: "Share expertise. Build credibility. Connect with the right opportunities.",
    cards: [
      {
        id: "brokers",
        icon: Handshake,
        ...
        description: "Showcase exclusive inventory, share market insights, and connect with serious buyers, tenants, and investors.",
        features: [
          { icon: User, labelDesktop: <>Personal<br/>Branding</>, labelMobile: "Personal Branding" },
          { icon: Building, labelDesktop: <>Inventory<br/>Showcase</>, labelMobile: "Inventory Showcase" },
      ...
      },
      {
        ...
        features: [
          { icon: Award, labelDesktop: <>Expert<br/>Positioning</>, labelMobile: "Expert Positioning" },
          { icon: FileText, labelDesktop: <>Content<br/>Publishing</>, labelMobile: "Content Publishing" },
  ...
  block3: {
    ...
    title: (
      <>
        Discover Opportunities <br className="hidden lg:block"/>with <span className="text-emerald-700 italic">Confidence.</span>
      </>
    ),
    subtitleBold: "Explore. Learn. Decide with Confidence.",
    subtitle: "Discover commercial properties, franchise networks, and retail businesses. Learn through expert videos, market insights, and business education before making your next move.",
    categories: [
      { icon: Building2, label: <>Commercial<br/>Properties</> },
      { icon: Store, label: <>Franchise<br/>Opportunities</> },
      { icon: ShoppingBag, label: <>Retail Business<br/>Opportunities</> },
      { icon: PlaySquare, label: <>Expert<br/>Videos & Insights</> }
    ],
    floaters: [
      { icon: ShieldCheck, labelDesktop: <>Verified<br/>Opportunities</>, labelMobile: "Verified Opportunities" },
      { icon: PlayCircle, labelDesktop: <>Video-Led<br/>Discovery</>, labelMobile: "Video-Led Discovery" },

      ...
      <main className="p-4 flex flex-col gap-6">
        ...
        {isLease && (
          <div className="bg-white rounded-[4px] border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.06)] p-5">
            <h3 className="text-[17px] font-bold mb-1 text-[#0a1128]">Tentative Lease Month</h3>
        ...
        {isFranchise && (
          <div className="bg-white rounded-[4px] border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.06)] p-5">
            <h3 className="text-[17px] font-bold mb-1 text-[#0a1128]">Daily Operations</h3>
            <p className="text-[11px] text-gray-500 font-medium mb-4 uppercase tracking-wider">How active will you be in daily operations?</p>
            <div className="flex flex-col gap-2.5">
        ...
        <div className="bg-indigo-50/50 rounded-[12px] border border-indigo-100 p-4 flex flex-col gap-3">
          ...
          <div className="text-[13px] text-indigo-900/70 font-medium">Locations: <span className="font-bold text-indigo-900">Anywhere in Hyderabad</span></div>
        </div>

    ...
    <div className="h-full min-h-full w-full bg-[#fafafb] dark:bg-[#060e24] text-[#0a1128] dark:text-white font-['Outfit',sans-serif] flex flex-col relative overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto scrollbar-hide flex flex-col gap-8 p-5 pb-32">
        ...
        <motion.div {...fadeUp} transition={{ delay: 0.1 }}>
          <h3 className="text-[18px] font-bold mb-1 text-[#0a1128] dark:text-white">What are you selling?</h3>
          <p className="text-[12px] text-gray-400 dark:text-white/40 mb-4 font-medium">Select the type of requirement you want to list.</p>
        ...
        {/* Property Categories (for sell/lease) */}

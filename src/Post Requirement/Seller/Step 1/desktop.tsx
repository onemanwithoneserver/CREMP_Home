      ...
      <main className="w-full max-w-3xl px-8 flex flex-col gap-10 -mt-4 mb-16 relative z-20">
        ...
        >
          ...
          <motion.div {...fadeUp} transition={{ delay: 0.35 }}>
            <h3 className="text-[20px] font-bold mb-1 text-[#0a1128] dark:text-white">What are you selling?</h3>
            <p className="text-[13px] text-gray-400 dark:text-white/40 mb-5 font-medium">Select the type of requirement you want to list.</p>
          ...
          <motion.div {...fadeUp} transition={{ delay: 0.45 }}>
            ...
            <p className="text-[13px] text-gray-400 dark:text-white/40 mb-4 font-medium">Give a name to easily identify this listing later.</p>
            <input 
              type="text" 

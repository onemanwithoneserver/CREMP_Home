    ...
    <div className="h-full min-h-full w-full bg-[#fafafb] dark:bg-[#060e24] text-[#0a1128] dark:text-white font-['Outfit',sans-serif] flex flex-col items-center overflow-y-auto scrollbar-hide">
      ...
      <div className="w-full relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-8 py-8 text-center">
          ...
          >
            Tell us what you're listing and we'll connect you with the right buyers and investors across India's premium commercial real estate market.
          </motion.p>
        </div>
      </div>
      ...
      <main className="w-full max-w-3xl px-8 flex flex-col gap-6 -mt-4 mb-8 relative z-20">
        ...
        >
          ...
          <motion.div {...fadeUp} transition={{ delay: 0.35 }}>
            <h3 className="text-[18px] font-bold mb-0.5 text-[#0a1128] dark:text-white">What are you selling?</h3>
            <p className="text-[13px] text-gray-400 dark:text-white/40 mb-3 font-medium">Select the type of requirement you want to list.</p>
          ...
          <motion.div {...fadeUp} transition={{ delay: 0.45 }}>
            ...
            <p className="text-[13px] text-gray-400 dark:text-white/40 mb-3 font-medium">Give a name to easily identify this listing later.</p>
            <input 
              type="text" 

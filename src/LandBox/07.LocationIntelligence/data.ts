...
export const locationIntelligenceData = {
  ...
  items: [
    ...
    },
    {
      ...
      status: "Calculating...",
      icon: BarChart3,
      bgClass: "bg-gradient-to-br from-[#10B981] to-[#047857] shadow-sm shadow-[#10B981]/20 border-none",
    },
    {
      label: "Neighbourhood Profile",
      status: "Processing...",
      icon: Home,
      bgClass: "bg-gradient-to-br from-[#8B5CF6] to-[#6D28D9] shadow-sm shadow-[#8B5CF6]/20 border-none",
    },
    {
      label: "Business Ecosystem",
      status: "Indexing...",
      icon: Globe,
      bgClass: "bg-gradient-to-br from-[#0EA5E9] to-[#0369A1] shadow-sm shadow-[#0EA5E9]/20 border-none",
    },
    {
      label: "Commercial Hotspots",
      status: "Analysing...",
      icon: Zap,
      bgClass: "bg-gradient-to-br from-[#F43F5E] to-[#BE123C] shadow-sm shadow-[#F43F5E]/20 border-none",
    },
    {
      label: "Connectivity Score",
      status: "Calculating...",
      icon: Train,
      bgClass: "bg-gradient-to-br from-[#14B8A6] to-[#0F766E] shadow-sm shadow-[#14B8A6]/20 border-none",
    },
    {

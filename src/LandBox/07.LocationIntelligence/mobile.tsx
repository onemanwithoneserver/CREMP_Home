        ...
        <div className="px-5 py-4 relative">
          <div className="absolute inset-0 bg-white/30 backdrop-blur-[1px] z-10 flex flex-col items-center justify-center group cursor-pointer hover:bg-white/40 hover:backdrop-blur-sm transition-all duration-500">
            ...
            <div className="bg-white/95 px-4 py-2 rounded-[4px] shadow-sm border border-gray-100/80 flex items-center justify-center h-8 relative overflow-hidden min-w-[70px] group-hover:min-w-[120px] transition-all duration-300">
              ...
              <span className="text-[0.65rem] font-semibold text-[#0b1b42] tracking-[0.2em] absolute transition-all duration-300 opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 whitespace-nowrap uppercase">
                Coming Soon
              </span>
            </div>
          </div>
          ...
          >
            {locationIntelligenceData.items.map((item, idx) => (
              <motion.div
                ...
                className="bg-gray-50/50 border border-transparent rounded-[4px] p-2.5 flex flex-col gap-1.5 relative transition-all duration-300 group cursor-default hover:bg-white hover:border-gray-100 hover:shadow-sm"
              >
                ...
                <div className="flex flex-col gap-1.5 mt-0.5">
                  <span className="text-[0.65rem] font-semibold text-[#0a1128] leading-[1.2] pr-1 tracking-tight">
                    {item.label}
                  </span>
                  <div className="flex items-center gap-1.5">
                    ...
                    />
                    <span className="text-[0.55rem] text-gray-500 font-semibold tracking-wider">
                      {item.status}
                    </span>
                  </div>
                </div>
          ...
          >
            <div className="bg-gray-50/50 p-3.5 flex items-center justify-between">
              ...
              <motion.button
                ...
                className={`text-[0.65rem] font-semibold px-3 py-1.5 rounded-[4px] shadow-sm border tracking-wider flex items-center justify-center transition-all duration-300 min-w-[85px] ${
                  isNotified
                    ? "bg-emerald-50/80 text-emerald-600 border-emerald-200 cursor-default"
                    : "text-[#0b1b42] bg-white border-gray-200 hover:border-[#0b1b42]/30 hover:bg-gray-50"
                }`}
              >

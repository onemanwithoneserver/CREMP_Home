  ...
  return (
    <>
      ...
      <div className="w-full z-50">
        ...
        <div className="relative z-50 w-full bg-[#0a1128] border-t border-[#d4af37]/30 shadow-[0_-10px_30px_rgba(0,0,0,0.25)] px-4 py-3 pb-[max(calc(env(safe-area-inset-bottom)+0.75rem),0.75rem)] flex items-center justify-center">

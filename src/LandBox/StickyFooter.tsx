  ...
  return (
    <>
      ...
      <div className="w-full z-50">
        ...
        <div className="relative z-50 w-full bg-[#0a1128] border-t border-white/10 shadow-[0_-15px_40px_rgba(0,0,0,0.6)] px-4 py-3 pb-[max(calc(env(safe-area-inset-bottom)+0.75rem),0.75rem)] flex items-center justify-center">

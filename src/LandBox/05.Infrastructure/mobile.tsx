        ...
        >
          {infrastructureData.items.map((item, idx) => (
            <motion.div
              ...
              className="flex items-center justify-between p-3.5 rounded-[8px] bg-white shadow-[0_2px_10px_rgba(0,0,0,0.02)] hover:shadow-[0_8px_20px_rgba(0,0,0,0.06)] border border-transparent hover:border-gray-200 transition-all duration-300 group cursor-default"
            >
              <div className="flex items-center gap-3.5">
                ...
                <div className="flex flex-col">
                  <span className="text-[0.8rem] font-semibold tracking-wide text-gray-700 group-hover:text-[#17274c] transition-colors">
                    {item.label}
                  </span>

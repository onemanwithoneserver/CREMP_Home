...
import { Sofa, CheckCircle2 } from "lucide-react";
      ...
      >
        ...
        <div className="px-6 py-6 flex flex-col gap-4 mx-0">
          <div className="border border-gray-100 rounded-[4px] overflow-hidden bg-white shadow-sm mt-1">
            <div className="w-full flex items-center justify-between p-3.5 bg-white border-b border-gray-100 text-[0.8rem] font-semibold text-[#0a1128] relative">

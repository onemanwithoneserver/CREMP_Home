      ...
      >
        ...
        <AnimatePresence initial={false}>
          {isOpen && (
            ...
            >
              <div className="px-5 py-4 flex flex-col gap-4 mx-0">
                <div className="border border-gray-100 rounded-[4px] overflow-hidden bg-white shadow-sm mt-1">
                  <button
                    ...
                    className="w-full flex items-center justify-between p-3 bg-gray-50/50 hover:bg-gray-50 text-[0.75rem] font-semibold text-[#0a1128] transition-colors"
                  >
